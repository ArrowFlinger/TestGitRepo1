NAuction.prototype.beginner = function(item)
{
								...
								if(price!=item.Product.price){
									...
									auction_elements.fadeIn(400, function () {
										...
										if(item.Users.lat!=""){
                                                                                        if(themename!='white')
											{        
											Auction.gmap(item.Users.lat,item.Users.lng);
											}
                                                                                }
										}*/
										if($(".productDetail").length){
...
NAuction.prototype.timer_beginner=function(auctionId,type)
{
			...
			else
			{
				...
				{					
					...
					console.log(countdownset+" Future");
					if(countdownset < 2){
