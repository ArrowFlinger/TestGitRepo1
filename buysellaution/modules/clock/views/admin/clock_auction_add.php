...
<div class="cont_container mt15 mt10">
   <div class="content_top">
      <div class="top_left"></div><div class="top_center"></div><div class="top_rgt"></div>
   </div>
   <div class="content_middle">
      ...
      <? if($product_data['startdate']!=""){ ?>
      <tr>
         <td valign="top" ><label><?php echo __('product_start_date'); ?></label><span class="star">*</span></td>
         <td>
            <div class="width400">
               <input type="text" name="startdate"    value="<?php echo isset($validator['startdate']) &&!array_key_exists('startdate',$errors)? $validator['startdate']:$product_data['startdate']; ?>" readonly=" readonly" class="DatePicker" onChange="serveralert()" readonly/>
            </div>
            <span class="error">
      ...
      <?php } ?>
      <tr>
         <td valign="top" ><label><?php echo __('product_end_date'); ?></label><span class="star">*</span></td>
         <td>
            <div class="width400">
      ...
      <tr>
         <td valign="top" ><label><?php echo __('product_cost'); ?></label><span class="star">*</span></td>
         <td>
            <div class="width400">
      ...
      <tr>
         <td valign="top" ><label><?php echo __('product_current_price'); ?></label><span class="star">*</span></td>
         <td>
            <div class="width400">
      ...
      <tr>
         <td valign="top" ><label><?php echo __('bidding_reduction_amount'); ?></label><span class="star">*</span></td>
         <td>
            <div class="width400">
      ...
      <tr>
         <td valign="top" ><label><?php echo __('reduction_label'); ?></label><span class="star">*</span></td>
         <td>
            <div class="width400">
               <input type="text" name="reduction" id="reduction"  maxlength ="12" value="<?php echo isset($product_data['reduction']) &&!array_key_exists('reduction',$errors)? $product_data['reduction']:$validator['reduction']; ?>" /><?php echo $sitesettings ; ?>
            </div>
            <span class="error">
               <?php echo isset($errors['reduction'])?ucfirst($errors['reduction']):""; ?>
            </span>                                 	   
            <span class="info_label"><?php echo __('reduction_info_label');?></span>
         </td>      
      </tr>
      <tr>
         <td valign="top" ><label><?php echo __('min_limit_price'); ?></label><span class="star">*</span></td>
         <td>
            <div class="width400">
               <input type="text" name="min_limit_price" id="min_limit_price"  maxlength ="12" value="<?php echo isset($product_data['min_limit_price']) &&!array_key_exists('min_limit_price',$errors)? $product_data['min_limit_price']:$validator['min_limit_price']; ?>" /><?php echo $sitesettings ; ?>
            </div>
            <span class="error">
               <?php echo isset($errors['min_limit_price'])?ucfirst($errors['min_limit_price']):""; ?>
            </span>                                 	   
            <span class="info_label"><?php echo __('min_limit_price');?></span>
         </td>      
      </tr>
      <tr><td colspan="2"><?php echo __('auction_type_label'); ?>: <?php echo __('clock_auction_label');?></td></tr>
      <tr>
      ...
      <tr>
         <td colspan="3" style="padding-left:110px;"> <br />
            ...
            <input type="submit" value="<?php echo ($action == 'add' )?''.
               __('start_auction').'':''.__('start_auction').'';?>"
               name="<?php echo ($action == 'add' )?'start_auction':'start_auction';?>" />
            <div class="clr">&nbsp;</div>
         </td>
      </tr> 
   </table>
...
<div class="content_bottom">
   <div class="bot_left"></div><div class="bot_center"></div><div class="bot_rgt"></div>
</div>
</div>
</div>
