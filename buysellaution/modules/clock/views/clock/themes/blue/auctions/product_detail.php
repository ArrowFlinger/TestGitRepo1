    ...
    <?php } } ?>
        ...
        <div class="deal-left clearfix">
            ...
            <!-- Message flash-->
                ...
                <div class="product_container re_product_container clr auction_item clock_product_container" id="auction_<?php echo $id; ?>" name="<?php echo URL_BASE; ?>auctions/process">
                                ...
                                <div class="price-container fl">
                                    ...
                                    <div class="product_details_right_inner clearfix">
                                        ...
                                        <div class="product_details_right_inner_middle">
                                            <ul class="timer-list">
                                                <li class="roming"><p class="fl"><?php echo __('price_label'); ?>&nbsp;:&nbsp;</p><span class="fl"><span class="currentprice"><?php echo ($product_result['product_process'] == CLOSED) ? $site_currency . " " . $product_result['current_price'] : $product_result['current_price']; ?></span><span class="price" style="display:none;"></span></span></li>
                                ...
                                <div class="product_sidebar1 fl clr">
                                    ...
                                    <div class="bid-block clearfix fl">
                                        ...
                                        <div class="product-middle clearfix">
                                            ...
                                            <!--Bid history-->
                                            <div class="bid_history" id="<?php echo URL_BASE; ?>site/clock/bid_history/<?php echo $id; ?>"
                                                 style="" rel="<?php echo $product_result['lastbidder_userid']; ?>"  name="<?php echo $auction_userid; ?>">
                                                <img src="<?php echo IMGPATH . 'ajax-loader.gif'; ?>"/></div><!--End of bid history-->
