<?php foreach ($productsresult as $product_result): ?>
    <div id="auction_<?php echo $product_result['product_id']; ?>" class="auction_item auction_item_content future_auction_item clock clock_product_container" name="<?php echo URL_BASE; ?>auctions/process">
