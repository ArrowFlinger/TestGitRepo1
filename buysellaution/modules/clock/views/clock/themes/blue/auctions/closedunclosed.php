<?php foreach ($productsresult as $product_result):
	...
	if($product_result['in_auction']==2 || $product_result['product_process']==CLOSED){
?>

<div class="auction_item_content clock clock_product_container" name="<?php echo URL_BASE;?>auctions/process">
