      ...
      <div class="main_container fl clr">
               ...
               <div class="wrapper">
                  ...
                  <div class="actions_black_autorize_mid_bg">
                     <div class="container_right">
						<form id="paymentsubmit" action="<?php echo URL_BASE;?>process/gateway">
							<input type="hidden" value="<?php echo $product_result['id'];?>" name="form[id][]">
							<input type="hidden" value="<?php echo Commonfunction::numberformat($product_result['unitprice']);?>" name="form[unitprice][]">
        ...
        <div class="amount">
		     ...
		     <p><?php echo Commonfunction::date_to_string($productdetails['enddate']); ?></p>
                   ...
                   <div class="buttons_nes1"></div>
        <div class="grand_total_btn_cp">
						<div class="save_left"></div>
						<div class="save_mid">
						<a onclick="$('#paymentsubmit').submit();" href="javascript:;" title="<?php echo __('buynow_lable')?>"><input type="button" value="<?php echo __('buynow_lable'); ?>"></a>
						</div>
						<div class="save_right"></div>			
				</div>
			<div class="profil_butoon" style="width:118px;padding-left:10px;">
					<div class="res_left"></div>
					<div class="res_mid_can" >
							<a id="paymentcancel" href="javascript:;" title="<?php echo __('Cancel')?>" ><input type="button" class="bluebg" value="<?php echo __('Cancel'); ?>"></a>
					</div>
