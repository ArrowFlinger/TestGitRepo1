...
<?php $i=0;foreach($bid_histories as $bid_history):?>
		...
		<tr>
                            <td width="80" align="left"><?php echo $site_currency." ".Commonfunction::numberformat($bid_history['price']);?></td>
                            <td width="105" align="left"><?php echo $bid_history['username'];?></td>
                            <td width="82" align="left"><?php echo $bid_history['date'];?></td> 
