   ...
   <div class="main_container_in">
      <div class="main_container fl clr">
         <div class="wrapper_outer" id="process_page">
            ...
            <div id="managetable" class="fl clr" style="width:925px !important;">
	 ...
	 <!-- /******/ -->
        ...
        <div class="amount">
		  ...
		  <div class="amount">
                      <div class="bidme_link fl" style="margin: 0 0 0 0px;">
		     <div class="bidme_link_left fl" style="margin: 0 0 0 0px;"></div>
	       <div class="bidme_link_middle fl" style="text-align: center;">
	     ...
	     <div class="bidme_link fl" style="margin: 0 0 0 0px;">
	        <div class="bidme_link_left fl" style="margin: 0 0 0 5px;"></div>
	        <div class="bidme_link_middle fl" style="text-align: center;">
