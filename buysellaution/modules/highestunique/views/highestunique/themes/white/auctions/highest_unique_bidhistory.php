        ...
        <div class="fl">
           ...
           <?php if($product_result['product_featured']==FEATURED){?>
            ...
            <div class="detail_feature_bott_lft"><div class="sliders">           
			  ...
			  <a href="#"><img width="18" height="18" alt="Beginner" title="Beginner" src="<?php echo IMGPATH; ?>head_top1_bg.png"/></a>
			  <?php }?>
			  <?php if($product_result['auction_type']=="30"){?>
              <a href="#"><img width="18" height="18" alt="Penney" title="Penney" src="<?php echo IMGPATH; ?>head_top2_bg.png"/></a>
              <?php }?>
              <?php if($product_result['auction_type']=="26"){?>
              <a href="#"><img width="18" height="18" alt="Peak" title="Peak" src="<?php echo IMGPATH; ?>head_top3_bg.png"/></a>
              <?php }?>
