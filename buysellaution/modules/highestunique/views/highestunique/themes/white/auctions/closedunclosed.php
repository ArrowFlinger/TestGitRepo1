		...
		<div class="feature_left_box"> <div class="auction_lft">			  
            ...
            <div class="feature_bott_lft">
				<div class="sliders">
					...
					<a><img src="<?php echo IMGPATH;?>Highest_unique_small.png" width="18" height="18" alt="<?php echo __('highest_label'); ?>"  title="<?php echo __('highest_label'); ?>"  /></a>
             ...
             <div class="bidme_link">
				<div class="bidnow_lft"></div>
					<div class="bidnow_mid">                
						 <p>
							 <a href="<?php echo URL_BASE; ?>auctions/view/<?php echo $product_result['product_url']; ?>"><?php echo __('bid_me_label');?> </a>
						 </p>                                        
					</div>
                <div class="bidnow_rgt"></div>
                </div>
