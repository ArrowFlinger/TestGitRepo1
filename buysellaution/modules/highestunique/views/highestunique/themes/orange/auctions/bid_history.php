...
<ul> 
		...
		$bid_history_value_count = array_count_values($bid_history_array);
				...
				<?php $bg_none=($i==$count-1)?'bg_none':"";?>
                    ...
                    <div class="blue_type_bid1"><span style="color:#E37900;font:normal 11px/15px arial;float:left;text-align:center;padding-top:12px;" title="highest but not unique">
                    <?php  
