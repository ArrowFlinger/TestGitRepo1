...
<div class="detail-inner clearfix">
            ...
            <div class="orange_bidhistory_all">
                <div class="orange_bidhistory_left">
                    ...
                    <div class="orange_bidhistory_mid">
                        ...
                        <div class="peak_icon_highest"></div>
                        <div class="bonus_icon_highest"></div>
						...
						?>
							<a href="#"><img src="<?php echo $no_img_path;?>" alt="<?php echo $product_result['product_name'];?>" border="0" title="Image" height="200px" width="300px" /></a>						
						<?php
						}
						else
						{ ?>
							<a href="#"><img src="<?php echo $product_full_size;?>" alt="img" border="0" title="Image" height="200px" width="300px" /></a>
							<?php }
						?>
					</div>
        ...
        <div class="blue_tab_outer bid_history1">
            ...
            <div class="tab_cont_bg">
                ...
                <div class="bid_history" id="<?php echo URL_BASE;?>site/highestunique/bid_history_all/<?php echo $id;?>" rel="<?php echo $product_result['lastbidder_userid'];?>"  name="<?php echo $auction_userid;?>"><img src="<?php echo IMGPATH.'ajax-loader.gif';?>"/> 
