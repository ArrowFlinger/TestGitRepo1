...
<?php if($product_result['product_featured']==HOT){?><span class="hot_icon_product"></span><?php } ?>                    
					...
					elseif(($product_result['product_gallery']=="")&&($product_result['product_image']!==""))
					{
						$product_full_size=URL_BASE.PRODUCTS_IMGPATH_THUMB5.$product_result['product_image'];
						?>
						<li> <a href="<?php echo $product_full_size;?>" title="<?php echo __('image');?>"> <img src="<?php echo $product_full_size;?>" class="image0"  alt="test" width="81" height="54"  /> </a> </li>
						<?php }
					else
					{ ?>
					...
					?>					
					<li> <a href="<?php echo $product_fullimagee_size;?>" title="<?php echo __('image');?>"> <img src="<?php echo $product_thumb_size;?>" class="image0"  alt="test" width="81" height="54"  /> </a> </li>					
					<?php					
					}
					}
					?>
        ...
        <div class="history_block clearfix">
            <div class="price-block1">
                ...
                <p class="currentprice"><?php echo ($product_result['product_process']==CLOSED)? $site_currency." ".Commonfunction::numberformat($product_result['current_price']):$site_currency." ".Commonfunction::numberformat($product_result['current_price']);?></p>
            </div>
				...
				<?php if($product_result['buynow_status']==ACTIVE && $product_result['product_process']!='C'):?>                  
				  <div class="buy-left">
                    ...
                    <div class="share clearfix">
                        ...
                        <ul>
                            <li class="twit"><a href="http://twitter.com/share?url=<?php echo $url;?>&amp;text=<?php echo $product_result['product_name'];?>" target="_blank"  title="Twitter" class="fl">
