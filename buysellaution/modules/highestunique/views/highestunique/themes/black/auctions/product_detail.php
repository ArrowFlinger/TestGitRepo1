...
<?php if($product_result['product_featured']==HOT){?><span class="hot_icon_product"></span><?php } ?>                    
					...
					?>
					<li> <a href="<?php echo $no_img_path;?>" title="<?php echo __('image');?>"> <img src="<?php echo $no_img_path;?>" class="image0"  alt="test" width="81" height="54"  /> </a> </li>
					<?php
					}
					elseif(($product_result['product_gallery']=="")&&($product_result['product_image']!==""))
					{
						...
						$product_full_size=URL_BASE.PRODUCTS_IMGPATH_THUMB5.$product_result['product_image'];
						?>
						<li> <a href="<?php echo $product_full_size;?>" title="<?php echo __('image');?>"> <img src="<?php echo $product_small_size;?>" class="image0"  alt="test" width="81" height="54"  /> </a> </li>
						<?php }
				...
				<?php if($product_result['buynow_status']==ACTIVE && $product_result['product_process']!='C'):?>                  
				  <div class="buy-left">
                    ...
                    <div class="share clearfix">
                        ...
                        <ul>
                            <li class="twit"><a href="http://twitter.com/share?url=<?php echo $url;?>&amp;text=<?php echo $product_result['product_name'];?>" target="_blank"  title="<?php echo __('twitter_icon');?>" class="fl">
                                            <img src="" alt="" border="0" class="fl"s/>
                                        </a></li>
                            <li class="face"><a href="https://www.facebook.com/sharer.php?u=<?php echo $url;?>&t=<?php echo $product_result['product_name'];?>" title="<?php echo __('facebook_icon');?>" class="fl" target="_blank">
