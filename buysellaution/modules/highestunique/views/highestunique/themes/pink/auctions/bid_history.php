...
<div class="blue_price1"> <?php  echo $site_currency." ".$bid_history['price'];?></div>
<div class="blue_bidder1"><?php echo $bid_history['username'];?></div> 
<div class="blue_date1"><?php echo $bid_history['date'];?></div> 

<div class="blue_type_bid1"><span style="color:#CE047D;font:normal 11px/15px arial;float:left;text-align:center;padding-top:12px;" title="highest but not unique">
<?php 
