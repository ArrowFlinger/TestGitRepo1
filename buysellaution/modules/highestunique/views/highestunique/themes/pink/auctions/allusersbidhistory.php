...
<ul> 
<li class="firs_list_blue"><div class="blue_price"><?php echo __('price_label');?></div><div class="blue_bidder"><?php echo __('Bidder_label');?></div> <div class="blue_date"><?php echo __('Date_label');?></div> <div class="blue_type_bid"><?php echo __('Bid_typelabel');?></div>  </li>
<?php
...
<div class="blue_price1"> <?php  echo $site_currency." ".Commonfunction::numberformat($bid_history['price']);?></div>
<div class="blue_bidder1"><?php echo $bid_history['username'];?></div> 
<div class="blue_date1"><?php echo $bid_history['date'];?></div> 

<div class="blue_type_bid1"><a href="#" title="highest but not unique">
<?php 
