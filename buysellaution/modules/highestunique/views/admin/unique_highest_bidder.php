<?php defined('SYSPATH') OR die("No direct access allowed."); //print_r($winner_auctions);exit;
...
<?php if($total_winner > 0){ ?>
                <tr class="rowhead">
				    ...
				    <th align="left" width="15%"><?php echo __('highest_unique_bid_price_label')."(".$site_currency.")"; ?></th>     
			...
			<td width="25%"><?php echo $site_currency." ".Commonfunction::numberformat($auctions['highest_unique_price']); 
	...
	//For No Records
       	...
       	<tr >
        	<td align="center" class="nodata"><?php echo __('no_highest_unique_won_product_found'); ?></td>
        </tr>
		<?php } ?>
</table>
<?php if($total_winner > 0){ ?>
