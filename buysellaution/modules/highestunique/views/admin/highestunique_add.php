...
<div class="cont_container mt15 mt10">
    ...
    <div class="content_middle">
        <form method="post" enctype="multipart/form-data" class="admin_form" name="add-product" id="add-product">
                  ...
                  <!-- Code to select user name in drop down- -->
                        ...
                        <tr>
                                <td valign="top" ><label><?php echo __('product_end_date'); ?></label>
                                        ...
                                        <td>
                                        <div class="width400">
                                          <input type="text" name="enddate" id="enddate"  value="<?php echo isset($validator['enddate']) &&!array_key_exists('enddate',$errors)? $validator['enddate']:$product_data['enddate']; ?>" readonly=" readonly" class="DatePicker" />                                   </div>
                                        <span class="error">
			 ...
			 <tr>
                                <td valign="top" ><label><?php echo __('bidamount_label'); ?></label>
                                        ...
                                        <input type="text" name="bidamount" id="bidamount"  maxlength ="12" value="<?php echo isset($product_data['bidamount']) &&!array_key_exists('bidamount',$errors)? $product_data['bidamount']:$validator['bidamount']; ?>" class="required chkvals text" title="bidamount" /><?php echo $sitesettings ; ?>
                        ...
                        <td colspan="2"><?php echo __('auction_type_label'); ?>: <?php echo __('highest_auction_label');?></td>
                        ...
                        <tr><td colspan="2"><input type="hidden" id="todaytime" value="<?php echo date('Y-n-j-G-i-s',time()); ?>"/></td></tr>
