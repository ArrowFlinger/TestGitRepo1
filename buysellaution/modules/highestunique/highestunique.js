...
NAuction.prototype.highestunique = function(item)
{
...
NAuction.prototype.timer_highestunique=function(auctionId,type)
{
...
$(function(){
	...
	$(".popup_close, .cancel_highest").live('click',function(){
		$('#fade, #box').fadeOut();
	       })
	      
                 $(".highestuniquebid").live('click',function()
			{					
				...
				if(!a['auction_'+id]['bid'].hasClass('new_block')){			
					NAuction.HighestuniqueBid(biddingurl,id,a['auction_'+id]['timestamp_diff'],formid);	
				}
			});               
                 ...
                 $(".toggleul_3 li:last").after('<li>\
                    ...
                    <a href="'+checkdefined(language.baseurl)+'admin/highestunique/unique_highest_bid_price" class="menu_rgt1" title="'+checkdefined(language.auction_menu_highest_unique_bid_price)+'">\
                        <span class="pl15">'+checkdefined(language.auction_menu_highest_unique_bid_price)+'</span>\
                    </a>\
               </li>');
	       
	       $(".bidding_inner ul li:last").after('<li><a  title="'+language.highest_label+'" class="highestunique">'+language.highest_label+'</a></li>');
	       
	       //User panel menu
	       $(".user_panel_list ul li:nth-child(9),.dash_lsd ul li:nth-child(9)").after('<li class="fl clr "><a href="'+language.baseurl+'site/highestunique/highest_mybids" title="'+checkdefined(language.auction_highest_won)+'"  id="highestactive">'+checkdefined(language.auction_highest_won)+'</a></li>');
