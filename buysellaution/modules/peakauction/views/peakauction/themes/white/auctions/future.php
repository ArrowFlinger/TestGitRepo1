    	...
    	<div class="auction_type" data-auctiontype="<?php echo $product_result['auction_type'];?>"></div>
  		<div class="feature_left_box"> <div class="auction_lft">
            ...
            <div class="auction_rgt">
				  <label><a href="<?php echo URL_BASE;?>auctions/view/<?php echo $product_result['product_url'];?>" title="<?php echo ucfirst($product_result['product_name']);?>"><?php echo strlen($product_result['product_name'])>19?ucfirst(Text::limit_chars($product_result['product_name'],15))."...":ucfirst($product_result['product_name']);?></a></label>
					<ul>
						<li> 
           ...
           <div class="auction_bott">
              ...
              <div class="sliders" style="width:133px;float:left;">
            ...
            <a style="float:right;" title="<?php echo __('add_to_watchlist');?>" rel="<?php echo $product_result['product_id'];?>" class="addwatchlist" name="<?php echo URL_BASE;?>auctions/addwatchlist"><img style="margin-top:0px;" src="<?php echo IMGPATH;?>plus_bg.png" width="24" height="25" alt="<?php echo __('add_to_watchlist'); ?>" /></a>
                  </div>            


					
					
					<div class="feature_bott_rgt" class="slider_loding_ie1">
