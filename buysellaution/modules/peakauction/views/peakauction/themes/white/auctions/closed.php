<?php defined("SYSPATH") or die("No direct script access."); ?>
	<?php foreach($productsresult as $product_result):?>
		<div class="feature_left_box"> <div class="auction_lft">		  
			...
			?>                       
			<img src="<?php echo $product_img_path; ?>" width="122" height="122" title="<?php echo ucfirst($product_result['product_name']); ?>" alt="<?php echo $product_result['product_name']; ?>" /><?php if ($product_result['product_process'] == CLOSED && $product_result['lastbidder_userid'] != 0) { ?><img src="<?php echo IMGPATH . SOLD_IMAGE; ?>"class="sold_image"/><?php } ?></a>
		</div>
			...
			<div class="feature_bott_lft">
              ...
              <div class="feature_bott_rgt">             
                ...
                <?php echo __('sold');?></a>
				<?php }else{ ?>
					<a title="<?php echo __('unsold');?>" name="<?php echo URL_BASE;?>auctions/bid/<?php echo $product_result['product_id'];?>"><?php echo __('unsold');?></a>
				<?php }?></p>
                </div>
