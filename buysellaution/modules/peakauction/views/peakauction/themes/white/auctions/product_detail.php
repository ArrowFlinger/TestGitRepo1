...
<?php //echo IMGPATH.SOLD_IMAGE;exit;
$id="";
		...
		<div class="detail_page_top">    
			...
			<div id="slide_content">	
				<div id="slider">
					...
					{ ?>
                    <li> <a href="<?php echo $product_full_size;?>" title="Image"> <img src="<?php echo $product_full_size;?>" class="image0"  alt="test" width="81" height="54"  /> </a><?php if($product_result['product_process']==CLOSED  && $product_result['lastbidder_userid']!=0){?><img src="<?php echo IMGPATH.SOLD_IMAGE;?>"class="sold_image"/><?php } ?>
                    </li>
                    <?php
					...
					<ul class="clearfix">
						...
						<li>
							...
							<label style=" float:left;padding-left:72px;display:block;color:#666;">
								...
								<span class="min"><?php echo __('hrs_label'); ?></span>
						...
						<li class="hb_li_padding_bottom_none">
							...
							<div class="hb_buy_now_right hb_buy_now_right1">
								<span class="hb_font_size_small"><p class="pricepaid">
								<?php 
						...
						<li class="border_none">
							...
							<?php  $saveover=$product_result['product_cost'] - $product_result['current_price'];echo ($saveover>0)? $site_currency." ".Commonfunction::numberformat($saveover):$site_currency." ". 0;?></span></p>
