...
<div class="container-block">
    ...
    <div class="auction_type" data-auctiontype="<?php echo $product_result['auction_type'];?>"></div>
     ...
     <div id="welcomeHero">
		<div id="slideshow-main">
			<ul>
				<li class="p1 active">
					<a class="fl lightbox" title="<?php echo ucfirst($product_result['product_name']);?>"> <img src="<?php echo $product_full_size;?>" width="365" height="285" border="0" class="fl" /><?php if($product_result['product_process']==CLOSED && $product_result['lastbidder_userid']!=0){?><img src="<?php echo IMGPATH.PRODUCTSOLD_IMAGE;?>"class="sold_image"/><?php } ?></a>
				</li>
        	...
        	<div class="product_sidebar1 fl clr">
                ...
                <div class="product-middle clearfix">
                	<ul class="bidding-table clearfix">
                            ...
                            <li class="fl" style="width:100px;"><?php echo __('Date_label');?></li>
			    <li class="fl" style="width:100px;"><?php echo __('Bid_typelabel');?></li>
			</ul>
		<!--Bid history-->
    ...
    <div class="product_detail_top_right clearfix">
                <div class="price-container fl">
                        ...
                        <ul class="timer-list">
                        <li class="not"><p class="fl" style="font-size:14px; margin-left:33px;  font-weight:bold;color:#2891c2;"><?php echo __('price_label');?> :</p><p class="fl"  style="font-size:14px; font-weight:bold;"><span class="currentprice" style="color:#2891c2;"><?php echo ($product_result['product_process']==CLOSED)? $site_currency." ".$product_result['current_price']:$product_result['current_price'];?></span><span class="price" style="display:none;"></span></p></li>
                       
                        <li> <p class="fl" style="font-size:14px;margin-left:25px; font-weight:bold;"><?php echo __('highest_bidder_label');?>:</p><p class="fl" style="font-size:14px; font-weight:bold;"><b><strong class="lastbidder"><?php echo ($product_result['lastbidder_userid']==0)?__('no_bids_yet'):ucfirst($product_result['username']);?></strong></b></p> </li>
                        
                        <li style="padding:5px 0 0 0;"><div class="product_timer fl" style="margin-left:16px;">
                        ...
                        <a href="javascript:;" name="<?php echo URL_BASE;?>auctions/bid" class="bid" data-auctiontype="<?php echo $product_result['auction_type'];?>"   rel="<?php echo URL_BASE;?>users/login/" id="<?php echo $product_result['product_id'];?>"><?php echo __('bid_me_label');?></a><?php }else if($product_result['product_process']==CLOSED){ ?>
				...
				<a class="moving_tt" href="<?php echo URL_BASE;?>site/buynow/buynow_addcart/<?php echo $product_result['product_id'];?>" title="<?php echo __('buy_now');?>"><img src="<?php echo IMGPATH;?>buynow_3.png"></a>		
                   	...
                   	<div class="product_bid_price fl">
                          ...
                          <div class="price-middle clearfix">
                            ...
                            <th align="center"><?php echo __('price_increases_by_label');?></th>
                               ...
                               <tr><td align="center"><p style="width:200px;color:#2891c2;" class="bidamount"><?php echo $site_currency." ".$product_result['bidamount'];?></p></td>
                            </tr>
                            	<tr>
                                	<th align="center"><?php echo __('retail_price_label')?></th>
                                      </tr>   <tr> <td align="center"><p  style="width:200px;color:#2891c2;"><?php echo $site_currency." ".Commonfunction::numberformat($product_result['product_cost']);?></p></td>
                                </tr>
                                <tr>
                                	<th align="center"><?php echo __('price_paid_user');?> </th>
                                       </tr>   <tr><td align="center"><p  style="width:200px;color:#2891c2;" class="pricepaid"><span class="" style="color:#2891c2;"> <?php 
			$user_spents=$auction->winner_user_amount_spent($product_result['product_id'],$product_result['lastbidder_userid']);
                    	...
                    	<div class="product_price_detail fl mt15">
                          ...
                          <div class="save-middle clearfix">
                        	...
                        	<p class="clr" ><?php echo __('save_over_label');?></p>
                                    <label  style="display:block; float:none;"  class="saveover">
					...
					echo ($saveover>0)? $site_currency." ".Commonfunction::numberformat($saveover):$site_currency." ". 0;?>
                                    ...
                                    <b class="clr mt5"><?php echo __('from_the_normal_retail_price_label');?> </b >
                                </div>
                            </div>
                            <div class="save-bl">
                            <div class="save-br">
                        ...
                        <div class="product_desc fl">  
                            <div class="whit_on_top">
                            <h2 class="product_detail_title product_detail_title1" style="color:#000;"><?php echo __('product_description');?></h2>
                            </div>
		                 <div class="whit_on_mid">
                         <p class="product_detail_description"><?php echo $product_result['product_info'];?></p></div>
                          <div class="whit_on_bot"></div>
                       	</div>
                        </div>  
                    <!-- Message flash-->
...
<div class="table-block" style="border-bottom:0px;">
    <div class="whit_top"> <h2 class="product_detail_title"><?php echo __('auctions_details');?></h2> </div>
    <div class="whit_mid">
   ...
   <div class="whit_bot"></div>
  </div>
    </div>
       </div>
   <div class="product_btm_content_middle fl">
   <div class="whit_top"> <h2 class="product_detail_title"><?php echo __('price_details');?></h2></div>
   <div class="table-block" style="border-bottom:0px;">
     <div class="whit_mid">
