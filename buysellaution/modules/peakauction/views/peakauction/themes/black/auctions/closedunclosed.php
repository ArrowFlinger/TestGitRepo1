			...
			<div class="action_item_detail fl clr">
				<p class="fl clr"><span style="display:block;"><?php echo __('retail_price_label')." : </span> ".$site_currency." ".$product_result['product_cost'];?></p>
                  ...
                  <div class="action_bidder_name fl clr">
				  	<span class="high" style="display:block;"><?php echo __('highest_bidder_label');?> :</span> <span ><?php echo ($product_result['lastbidder_userid']==0)?__('no_bids_yet'):ucfirst($product_result['username']);?></span>
                  </div>
...
<p class="fl clr mt5"><?php echo "Auction Time: ".date('g:i A', strtotime($product_result['auction_starttime'])). " - ".date('g:i A', strtotime($product_result['auction_endtime'])) ;?></p>
                </div>
                </div>
