...
<div class="auction_type" data-auctiontype="<?php echo $product_result['auction_type'];?>"></div>
			...
			<?php if($product_result['product_featured']==FEATURED){?><span class="feature_icon"></span><?php } ?>
			 ...
			 <span class="peak"></span>
            		...
            		<img src="<?php echo $product_img_path;?>" width="150" height="100" title="<?php echo ucfirst($product_result['product_name']);?>" alt="<?php echo $product_result['product_name'];?>"/>
            	</a>
            </div>
<div class="bidme_link_out fl clr">
 ...
 <div class="action_price fl clr"><p class="fl"><!--<span style="display:block;"><?php echo __('price_label');?> : </span>--><span class="currentprice"></span></p></div>
<div class="new_com">

            <div class="action_bidder_name fl clr">
<div class="auction_bit_left">
<span class="high" style="display:block;"><?php echo __('highest_bidder_label');?>:</span><span class="lastbidder"><?php echo ($product_result['lastbidder_userid']==0)?__('no_bids_yet'):"";?></span>
</div>
 <div class="aution_bit_right"> <b><?php echo __('bid_label');?></b>
        ...
        <div class="auction_share_icon fl clr mt5" style="height:65px;" >
		   ...
		   <a style="float:left;"><fb:like  style="width:auto;float:left;" href="<?php echo $url = URL_BASE.'auctions/view/'.$product_result['product_url'];?>" layout="button_count" width="84" send="false" ref="" style="border:none;"  ></fb:like><?php //echo $include_facebook;?>	<!--End of facebook-->	 </a>
			...
			<div class="action_item_detail fl clr">
					...
					<p class="fl clr"><?php echo __("time_countdown_label")." : ".$product_result['bidding_countdown'];?> <?php echo ('secs');?></p>
			</div>
