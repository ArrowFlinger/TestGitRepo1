<?php defined("SYSPATH") or die("No direct script access."); ?>
	...
	<div class="auction_item_content">
       <div class="deal-top_f"> </div>
            ...
            <div class="price-block fl" style="width:95%;float:left;">
			<div class="bidme_link_out" style="width:100px;margin:0 auto;">
                        <center>
                 ...
                 <div class="action_price fl clr" style="width:95%;text-align:center;"><p class="fl"><?php echo  $site_currency." ".Commonfunction::numberformat($product_result['current_price']);?></p>
                  </div>
             </div>
...
<div id="auction_<?php echo $product_result['product_id'];?>" class="auction_item auction_item_content" name="<?php echo URL_BASE;?>auctions/process" data-id="<?php echo $product_result['product_id'];?>">
	     <div class="auction_type" data-auctiontype="<?php echo $product_result['auction_type'];?>"></div>	
			...
			?>
                ...
                <a href="javascript:;" name="<?php echo URL_BASE;?>auctions/bid" class="bid" data-auctiontype ="<?php echo $product_result['auction_type'];?>" title="<?php echo ($auction_userid=='')? __('login_label'):__('bid_me_label');?>" rel="<?php echo URL_BASE;?>users/login/" id="<?php echo $product_result['product_id'];?>">
