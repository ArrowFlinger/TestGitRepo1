...
<div class="container-block">
    ...
    <div class="auction_type" data-auctiontype="<?php echo $product_result['auction_type'];?>"></div>
    	  ...
    	  <div class="product_left  ml10 fl">
			...
			<ul>
				<li class="p1 active">
					...
					<a class="fl lightbox" title="<?php echo ucfirst($product_result['product_name']);?>"> <img src="<?php echo $product_full_size;?>" width="361" height="285" border="0" class="fl" /><?php if($product_result['lastbidder_userid']!=0 && $product_result['product_process']==CLOSED){?><img src="<?php echo IMGPATH.SOLD_IMAGE;?>"class="sold_image"/><?php } ?></a>
				</li>
		...
		<!--Lightbox link-->
              ...
              <a href="javascript:;" class="future addwatchlist" title="<?php echo __('add_to_watchlist');?>" rel="<?php echo $product_result['product_id'];?>"  name="<?php echo URL_BASE;?>auctions/addwatchlist"><?php echo __('add_to_watchlist');?></a>
                ...
                <div class="price-container">
                        ...
                        <tr>
	                        <td align="left" colspan="2">
                            	<div class="product_timer fl">
                                    ...
                                    <strong class="countdown countdown_red2"><?php echo ($product_result['product_process']!=CLOSED)?"<img src=".IMGPATH."ajax-loader.gif>":__('closed_text');?></strong>
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <a href="javascript:;" name="<?php echo URL_BASE;?>auctions/bid" class="bid" title="<?php //echo $error;?>"   rel="<?php echo URL_BASE;?>users/login/"  id="<?php echo $product_result['product_id'];?>" data-auctiontype="<?php echo $product_result['auction_type'];?>"><?php echo __('bid_me_label');?></a><?php }else if($product_result['product_process']==CLOSED){ ?>
	  ...
	  <!-- Place this tag where you want the +1 button to render -->
                ...
                <!--End of facebook-->
                   	...
                   	<div class="product_bid_price fl mt15">
                          ...
                          <div class="price-middle clearfix">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" align="right" class="   price_table" style="width:240px; ">
                            <tr>
		...
		<!--Bid history-->
			 <div class="bid_history" id="<?php echo URL_BASE;?>auctions/bid_history/<?php echo $id;?>"  rel="<?php echo $product_result['lastbidder_userid'];?>"  name="<?php echo $auction_userid;?>"><img src="<?php echo IMGPATH.'ajax-loader.gif';?>"/></div><!--End of bid history-->                      
                </div>
...
<div class="product_container product_desc clr pt10">
    ...
    <div class="shopping-block clearfix">
            ...
            <div class="shipping_title fl clr" style="border-bottom:0px;">
