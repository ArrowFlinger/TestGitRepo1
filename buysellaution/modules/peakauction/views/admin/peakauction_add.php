...
?>
<script src="<?php echo SCRIPTPATH;?>time.js" type="text/javascript"></script>
...
<div class="cont_container mt15 mt10">
    ...
    <div class="content_middle">
        <form method="post" enctype="multipart/form-data" class="admin_form" name="add-product" id="add-product">
			...
			<!-- Code to select user name in drop down- -->			
                        <tr>
                                <td valign="top" ><label><?php echo __('product_start_date'); ?></label>
                                        ...
                                        <td>
                                        <div class="width400">
                                        <input type="text" name="startdate" id="startdate"   value="<?php echo isset($validator['startdate']) && !array_key_exists('startdate',$errors)? $validator['startdate']:$product_data['startdate']; ?>"  class="DatePicker" onChange="serveralert()"/>
                                        </div>
                                        <span class="error">
                        ...
                        <tr>
                                <td valign="top" ><label><?php echo __('product_end_date'); ?></label>
                                        ...
                                        <td>
                                        <div class="width400">
                                        <input type="text" name="enddate" id="enddate"  value="<?php echo isset($validator['enddate']) && !array_key_exists('enddate',$errors)? $validator['enddate']:$product_data['enddate']; ?>"  class="DatePicker" />
                                        </div>
                                        <span class="error">
			...
			<!--Peak Start & End Time-->
			 <tr>
                                <td valign="top" ><label><?php echo __('peak_start_time'); ?></label>
                                        <span class="star">*</span>
                                        </td>
                                        <td>
                                        <div class="width400">
                                                      
                                        <input type="text" name="auction_starttime" id='auction_starttime' value="<?php echo isset($validator['auction_starttime']) && !array_key_exists('auction_starttime',$errors)? $validator['auction_starttime']:$product_data['auction_starttime']; ?>" />
                                        </div>
                                        <span class="error">
                                        <?php echo isset($errors['auction_starttime'])?ucfirst($errors['auction_starttime']):""; ?>
                                        </span>                                 	                                
                                </td>      
                        </tr>
                        <tr>
                                <td valign="top" ><label><?php echo __('peak_end_time'); ?></label>
                                        <span class="star">*</span>
                                        </td>
                                        <td>
                                        <div class="width400">
                                        <input type="text" name="auction_endtime" id="auction_endtime"  value="<?php echo isset($validator['auction_endtime']) &&!array_key_exists('auction_endtime',$errors)? $validator['auction_endtime']:$product_data['auction_endtime']; ?>" />
                                        </div>
                                        <span class="error">
                                        <?php echo isset($errors['auction_endtime'])?ucfirst($errors['auction_endtime']):""; ?>
                                        </span>                                 	                                   
                                </td>      
                        </tr>			
                         <tr>
			...
			<tr>
                        <td colspan="2"><?php echo __('auction_type_label'); ?>: <?php echo __('peak_auction_label');?></td>
                        </tr>                                       
                        <tr>
...
<script type="text/javascript">
	...
	stepSecond: 1
	 ...
	 $("#auction_starttime").timepicker( {
	showSecond: true,
	timeFormat: 'hh:mm:ss'
	} );
	 
	  $("#auction_endtime").timepicker( {
	showSecond: true,
	timeFormat: 'hh:mm:ss'
	} );
