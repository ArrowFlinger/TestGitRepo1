...
foreach ($productsresult as $product_result):
    ...
    ?>
        ...
        <div class="auction_share_icon fl clr mt5">
                    <a style="float:left;" href="http://twitter.com/share?url=<?php echo $url = URL_BASE . 'auctions/view/' . $product_result['product_url']; ?>" target="_blank" title="Twitter" ><img src="<?php echo IMGPATH . 'twitter_link_icon.png'; ?>" style="margin:2px 0px 0px 5px;"/></a>
                    <a style="float:left;" href="https://www.facebook.com/sharer.php?u=<?php echo $url = URL_BASE . 'auctions/view/' . $product_result['product_url']; ?>" target="_blank"  title="Facebook">
