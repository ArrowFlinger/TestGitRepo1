             ...
             <?php echo strlen($product_result['product_name'])>19?ucfirst(Text::limit_chars($product_result['product_name'],15))."...":ucfirst($product_result['product_name']);?>
              ...
              <div class="new_com">
					...
					<div class="minimum_info fl clearfix buyseat_details" style="display:none;">
						<?php echo __('min_seat_limit');?>:<?php echo $product_result['min_seat_limit'];?>
						<?php echo __('seat_cost');?>:<?php echo $site_currency." ".$product_result['seat_cost'];?>
						<?php echo __('seat_enddate');?>:<?php echo date('M d, Y',strtotime($product_result['seat_enddate']));?>
					</div>
					
					<?php /*
					<li>				
					
					<div class="action_price clr">
					
					<p class="seat_info"><span id="bseats" class="buyseatss" ></span><?php echo '/'.$product_result['max_seat_limit']; ?> <?php echo __('seat_label');?></p>
					...
					<li>
						<div class="buy_seats_button">
				<div class="bs_button_left"></div>
				<div class="bs_button_mid">
...
*/?>
				...
				<div class="new_com">
					<div class="countdown f18"><img src="<?php echo IMGPATH . 'ajax-loader.gif'; ?>"/></div>
				</div>
			...
			<?php }?>
              ...
              <div class="bidme_link">
                ...
                <div class="bidnow_mid">
                 ...
                 <p>  <a href="javascript:;" id="<?php echo $product_result['product_id']; ?>" name="<?php echo URL_BASE; ?>auctions/bid/" class="bid" title="<?php echo ($auction_userid == '') ? __('logins_label') : __('bid_now_label'); ?>" rel="<?php echo URL_BASE; ?>users/login?redirect=<?php echo urlencode(URL_BASE.'auctions/live/');?>"  data-auctiontype ="<?php echo $product_result['auction_type']; ?>">
                                            <?php echo __("bid_now_label");?>
                                        </a></p>
