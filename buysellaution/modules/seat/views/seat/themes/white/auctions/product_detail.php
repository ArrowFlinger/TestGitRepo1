...
//echo  $product_result['userid'];echo '---';
//echo $auction_userid; 
	...
	<div id="slide_content">
		...
		<div id="slider">
			<ul>							
				...
				<li><a href="#" title="<?php echo ucfirst($product_result['product_name']);?>"> <img src="<?php echo $product_img_path; ?>" width="353" height="297" alt="1" /></a></li>
			<?php	
          ...
          <div class="productDetail" style="display:none;"><?php echo $product_result['product_id'];?></div>  
            ...
            <div class="sliders">
             <span title="<?php echo __('seat_auction_label');?>" class="seaticon"></span>
       ...
       <div class="bid_history" id="<?php echo URL_BASE;?>auctions/bid_history/<?php echo $id;?>" style="" rel="<?php echo $product_result['lastbidder_userid'];?>"  name="<?php echo $auction_userid;?>"><img src="<?php echo IMGPATH.'ajax-loader.gif';?>"/></div>
		...
		<!--div class="hb_bg_left">
		</div-->
		<div class="hb_bg_mid">
			<ul class="clearfix">
				<li>
				
				<p><span><?php echo __('highest_bidder_label');?> :</span> <strong class="lastbidder"><?php echo ($product_result['lastbidder_userid']==0)?__('no_bids_yet'):ucfirst($product_result['username']);?></strong></p>
				</li>	
				
				<div class="product_timer fl">
				<li>
					
					<h3 class="countdown"><?php echo ($product_result['product_process']!=CLOSED)?"<img src=".IMGPATH."ajax-loader.gif>":__('closed_text');?></h3>
				...
				<li>
					<div class="hb_buy_now_left">
						<h3 class="currentprice" ><?php echo ($product_result['product_process']==CLOSED)? $site_currency." ".Commonfunction::numberformat($product_result['current_price']):$product_result['current_price'];?></h3><span class="price" style="display:none;"></span>
					</div>
