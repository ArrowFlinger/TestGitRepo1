<div class="popup_inner popup_inner2 seat_popup_content seat" style="text-align: left;">
<div class="popup_content">
   ...
   document.getElementById('fade').style.display='none'">close</a>
					  ...
					  <?php $balance = str_replace(",","",$user_current_balance);
						...
						<a href="<?php echo URL_BASE;?>packages/" style="color:#e37900;text-decoration: underline;"><?php echo __('buy_packages');?></a>
					  
					  <?php endif;?></p>
                                          <div class="MessageText" style="margin:5px 0 10px 0; color:#000; font:normal 12px/18px arial;">
                                             <?php echo __('you_pay');?>: <span style="color:#2691bf;font-weight:bold;"><?php echo $site_currency. $results['seat_cost'];?></span> <?php echo __('for_auction_seat');?>: <span style="color:#2691bf;font-weight:bold;"><?php echo ucfirst($results['product_name']);?></span>
					  </div>
                                            <div class="re_image">
