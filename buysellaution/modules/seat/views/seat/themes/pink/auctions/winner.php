 <?php  
        ...
        <div class="winners_detail_list fl clr seat">
        <div class="winners-top"></div>
          <div class="winners-middle clearfix">
            ...
            <div class="winners_detail_middle fl ml10">
                ...
                <!--Winner Location-->
                <span class="fl clr mt5"><?php echo __("ended_on_label").": ".$auction->date_to_string($winner_result['enddate']);?></span>
    <span class="fl clr mt5"><?php  echo $winner_result['country'];?></span>
                <!--view detail
                <a href="javascript:;" class="fl mt35" title="View Details">View Details</a>-->
            </div>
            <!-- WInner Name AND Winner Detail START-->
            <div class="winners_action_detail fr ml10"> 
            <div class="ribbon"></div>          	
            <div class="winners_action_detail_right fl">
                <table width="200" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                                <th colspan="2" align="center"><p style="word-wrap:break-word;"><?php echo ucfirst($winner_result['product_name']);?></p></th>
                        </tr>
                        <tr>
                                <td align="left" valign="top"><label><?php echo __('retail_price_label')?> :</label></td>
                                <td align="left" valign="top"><p><?php echo $site_currency;?> <?php echo $winner_result['product_cost'];?></p></td>
                        </tr>
                        <tr>
                                <td align="left" valign="top"><label><?php echo __('auction_price_label')?> :</label></td>
                                <td align="left" valign="top"><p><?php echo $site_currency;?> <?php echo Commonfunction::numberformat($winner_result['current_price']);?></p></td>
                        </tr>
                        <tr>
                                <td align="left" valign="top"><label><?php echo __('savings_label')?> :</label></td>
