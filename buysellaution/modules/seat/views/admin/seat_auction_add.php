        ...
        <form method="post" enctype="multipart/form-data" class="admin_form" name="add-product" id="add-product">
                <table border="0" cellpadding="5" cellspacing="0">
                  ...
                  <!-- Code to select user name in drop down- -->
                  	 <tr>
                  	 	<td ><label style="font-size:18px;"><?php echo __('seat_informations'); ?></label></td>
                  	 </tr>
			 <tr>
                                <td valign="top" ><label><?php echo __('seat_end_date'); ?></label>
                                        <span class="star">*</span>
                                        </td>
                                        <td>
                                        <div class="width400">
                                        <input type="text" name="seat_enddate" id="seat_enddate"  value="<?php echo isset($validator['seat_enddate']) &&!array_key_exists('seat_enddate',$errors)? $validator['seat_enddate']:$product_data['seat_enddate']; ?>" readonly=" readonly" class="DatePicker" />
                                        </div>
                                        <span class="error">
                                        <?php echo isset($errors['seat_enddate'])?ucfirst($errors['seat_enddate']):""; ?>
                                        </span>                                 	                                   
                                </td>      
                        </tr>
                         <tr>
                                <td valign="top" ><label><?php echo __('min_seat_limit'); ?></label>
                                        <span class="star">*</span>
                                        </td>
                                      <?php if($action == 'add') {  ?> 
                                        <td>
                                        <div class="width400">
                                        <input type="text" name="min_seat_limit" id="min_seat_limit"  maxlength ="4" value="<?php echo isset($product_data['min_seat_limit']) &&!array_key_exists('min_seat_limit',$errors)? $product_data['min_seat_limit']:$validator['min_seat_limit']; ?>" class="required chkamts text" />
                                        </div>
                                        <span class="error">
                                        <?php echo isset($errors['min_seat_limit'])?ucfirst($errors['min_seat_limit']):""; ?>
                                        </span>                                 	   
                                <span class="info_label"><?php echo __('select_minseat_label');?></span>
                                </td>      
                                <?php } else { if($product_data['auction_started']!=0) { ?> 
                                 <td>
                                        <div class="width400">
                                        <input type="text" name="min_seat_limit" id="min_seat_limit"  maxlength ="4" value="<?php echo isset($product_data['min_seat_limit']) &&!array_key_exists('min_seat_limit',$errors)? $product_data['min_seat_limit']:$validator['min_seat_limit']; ?>" class="required chkamts text" />
                                        </div>
                                ...
                                <?php } else { ?>
                                 <td>
                                        <div class="width400">
                                        <input type="text" name="min_seat_limit" id="min_seat_limit"  maxlength ="4" value="<?php echo isset($product_data['min_seat_limit']) &&!array_key_exists('min_seat_limit',$errors)? $product_data['min_seat_limit']:$validator['min_seat_limit']; ?>" class="required chkamts text" readonly="readonly"/>
                                        </div>
                                        <span class="error">
                                        <?php echo isset($errors['min_seat_limit'])?ucfirst($errors['min_seat_limit']):""; ?>
                                        </span>                                 	   
                         ...
                         <tr>
                                <td valign="top" ><label><?php echo __('max_seat_limit'); ?></label>
                                        <span class="star">*</span>
                                        </td>
                                      
                                        <td>
                                        <div class="width400">
                                        <input type="text" name="max_seat_limit" id="max_seat_limit"  maxlength ="4" value="<?php echo isset($product_data['max_seat_limit']) &&!array_key_exists('max_seat_limit',$errors)? $product_data['max_seat_limit']:$validator['max_seat_limit']; ?>" class="required chkamts text" />
                                        </div>
                                        <span class="error">
                                        <?php echo isset($errors['max_seat_limit'])?ucfirst($errors['max_seat_limit']):""; ?>
                                        </span>                                 	   
                                <span class="info_label"><?php echo __('select_maxseat_label');?></span>
                                </td>      
                              
                        </tr>
                        <tr>
                                <td valign="top" ><label><?php echo __('seat_cost'); ?></label>
                                        <span class="star">*</span>
                                        </td>
                                        <td>
                                        <div class="width400">
                                        <input type="text" name="seat_cost" id="seat_cost"  maxlength ="12" value="<?php echo isset($product_data['seat_cost']) &&!array_key_exists('seat_cost',$errors)? $product_data['seat_cost']:$validator['seat_cost']; ?>" class="required chkamts text" /><?php echo $sitesettings ; ?> 
                                        </div>
                                        <span class="error">
                                        <?php echo isset($errors['seat_cost'])?ucfirst($errors['seat_cost']):""; ?>
                                        </span>                                 	   
                                <span class="info_label"><?php echo __('select_seatcost_label');?></span>
                                </td>      
                        </tr>
                        
                        <tr>
                  	 	<td ><label style="font-size:18px;"><?php echo __('auction_informations'); ?></label></td>
                  	</tr>
                        ...
                        <tr>
                                <td valign="top" ><label><?php //echo __('product_start_date'); ?></label>
                                        ...
                                        <td>
                                        <div class="width400">
                                        <input type="hidden" name="startdate" id="startdate"   value="<?php echo date('Y-m-d'); ?>" readonly=" readonly"  />
                                        </div>
                        ...
                        <td colspan="2"><?php echo __('auction_type_label'); ?>: <?php echo __('seat_auction_label');?></td>
