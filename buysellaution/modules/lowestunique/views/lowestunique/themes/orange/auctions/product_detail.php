...
<div style="position:absolute;z-index:999;"><?php if($product_result['product_featured']==FEATURED){?><span class="feature_label"></span><?php } ?>
...
<?php if($product_result['product_featured']==HOT){?><span class="hot_icon_product"></span><?php } ?>                    
                   ...
                   <div class="lowestunique_big"></div>     </div>  
					...
					$product_fullimagee_size=URL_BASE.PRODUCTS_IMGPATH_THUMB150x150."thumb370x280/".$gallary_main_image;
            ...
            <div class="share-block">            	
				...
				<?php if($product_result['buynow_status']==ACTIVE && $product_result['product_process']!='C'):?>                  
				  <div class="buy-left">
                    ...
                    <?php if($product_result['product_process']!=CLOSED){?>
                    <div class="share clearfix" style="padding-top:10px;">
                        ...
                        <ul>
                            <li style="float:left;width:30px;" class="twit"><a href="http://twitter.com/share?url=<?php echo $url;?>&amp;text=<?php echo $product_result['product_name'];?>" target="_blank"  title="Twitter" class="fl">

                                        </a></li>
                            <li style="float:left;width:30px;" class="face"><a href="https://www.facebook.com/sharer.php?u=<?php echo $url;?>&t=<?php echo $product_result['product_name'];?>" title="Facebook" class="fl" target="_blank">
                                            <img src="<?php echo IMGPATH;?>s3.png" alt="Facebook" border="0" />
                                        </a></li>
                            <li style="float:left;width:auto;" class="flike"><fb:like href="<?php echo $url = URL_BASE.'auctions/view/'.$product_result['product_url'];?>" layout="button_count" width="84" send="false" ref="" style="border:none;"></fb:like></li>
                        </ul>
                    </div> <?php }?>
                </div>
            </div>
...
$(document).ready(function(){
	...
	add+='<input type="checkbox" class="bid_checkall"><span style="font:bold 12px arial;color:#2691C0;"><?php echo __("check_label");?><span>';
