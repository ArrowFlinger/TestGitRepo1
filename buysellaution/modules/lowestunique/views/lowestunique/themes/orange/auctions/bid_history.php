...
<ul> 
				...
				<?php $bg_none=($i==$count-1)?'bg_none':"";?>
                    ...
                    <div class="blue_type_bid1"><span style="color:#E37900;font:normal 11px/15px arial;float:left;text-align:center;padding-top:12px;" title="Lowest but not unique">
                    <?php 
