...
foreach($productsresult as $product_result):?>
        ...
        <div class="lowestunique"></div>
		  ...
		  <div class="action_bidder_name fl clr">
            ...
            <span class="read_more" ><a style="margin-top:10px;" href="<?php echo URL_BASE; ?>auctions/view/<?php echo $product_result['product_url']; ?>"title="<?php echo __('more_info');?>"><?php echo __('more_info');?></a></span>
