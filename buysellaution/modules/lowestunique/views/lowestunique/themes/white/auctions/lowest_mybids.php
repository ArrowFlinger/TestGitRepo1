...
<div class="my_message_right" id="lowest_mybids_page">
	<div class="message_common_border">
		<h1 title="<?php echo strtoupper(__('placed_unique_bid_product'));?>" style="width:66px;"><?php echo __('placed_unique_bid_product');?></h1>
	...
	<div class="forms_common">
		...
		<td width="100" align="center">
			<a title="<?php echo ucfirst($bidhistory['product_name']);?>" href="<?php echo URL_BASE;?>auctions/view_product_history/<?php echo $bidhistory['product_url'];?>" title="<?php echo ucfirst($bidhistory['product_name']);?>"> <?php echo strlen($bidhistory['product_name'])>19?ucfirst(Text::limit_chars($bidhistory['product_name'],15))."...":ucfirst($bidhistory['product_name']);?></a>
		</td>
		<td width="100" align="center">
		...
		<td width="100" align="center">
			   <?php echo $bidhistory['in_auction']!=2?"<a href='".URL_BASE."auctions/view_product_history/".$bidhistory['product_url']."' class='delet_link fr' title='".__('live_text')."'>".__('live_text')."</a>":"<h2 class='messages_new_watch'>".__('closed_text')."</h2>";?>
		</td>
		</tr>
		  <?php endforeach;?>
                                   </table>
	...
	<?php else:?>
	<div class="message_common">
		<h4  style="float:none;"><?php echo __("no_unique_lowest_bid_price_at_the_moment");?></h4>
		</div>
	<?php endif;?>
	<?php if($count_bidhistory>0):?>
...
$(document).ready(function () {$("#my_bids1_active").parents('li').addClass("act_class");});
</script>
