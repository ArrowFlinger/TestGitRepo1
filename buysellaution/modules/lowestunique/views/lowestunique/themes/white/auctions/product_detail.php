...
<ul>
<li><a title="Home" href="#"><?php echo __('menu_home');?></a></li>
...
<div class="product_container clr mt15 auction_item" id="auction_<?php echo $id;?>" name="<?php echo URL_BASE;?>auctions/process">
    ...
    <div class="detail_page_top" id="lowest_product_detail_page">
    ...
    <div class="detail-inner white-inner clearfix">
        ...
        <!-- slider part starts -->
			...
			<div id="slide_container">
					...
					$product_full_size=URL_BASE.PRODUCTS_IMGPATH.$product_result['product_image'];
					?>
					<li> <a href="<?php echo $product_full_size;?>" title="Image"> <img src="<?php echo $product_full_size;?>" class="image0"  alt="test" width="81" height="54"  /> </a><?php if($product_result['product_process']==CLOSED  && $product_result['lastbidder_userid']!=0){?><img src="<?php echo IMGPATH.SOLD_IMAGE;?>" style="float:left;"class="sold_image"/><?php } ?> </li>					
					<?php
					}
					elseif(($product_result['product_image']=="")&&($product_result['product_gallery']=="") )
					{  
					$no_img_path=IMGPATH.NO_IMAGE;?>
					<li> <a href="<?php echo $no_img_path;?>" title="Image"> <img src="<?php echo $no_img_path;?>" class="image0"  alt="test" width="81" height="54"  /> </a><?php if($product_result['product_process']==CLOSED  && $product_result['lastbidder_userid']!=0){?><img src="<?php echo IMGPATH.SOLD_IMAGE;?>" style="float:left;"class="sold_image"/><?php } ?> </li>					
					<?php
					}
					else
					{ ?>
                    ...
                    <li><a href="#" title="1"> <img src="<?php echo $product_fullimagee_size;?>" width="353" height="297" alt="1" /></a><?php if($product_result['product_process']==CLOSED  && $product_result['lastbidder_userid']!=0){?><img src="<?php echo IMGPATH.SOLD_IMAGE;?>" style="float:left;"class="sold_image"/><?php } ?></li>
                    <?php					
					}
					}
					?>                                            						
            ...
            <div class="detail_feature_bott_lft"><div class="sliders">           
              ...
              <a href="#"><img width="18" height="18" alt="<?php echo __('lowestunique_label'); ?>" title="<?php echo __('lowestunique_label'); ?>" src="<?php echo IMGPATH; ?>lowestunique.png"/></a>
              ...
              <a  title="<?php echo __('add_to_watchlist');?>" rel="<?php echo $product_result['product_id'];?>" class="addwatchlist" name="<?php echo URL_BASE;?>auctions/addwatchlist"><img width="24" height="25" alt="<?php echo __('add_to_watchlist'); ?>" title="<?php echo __('add_to_watchlist'); ?>" src="<?php echo IMGPATH; ?>plus_bg.png"/></a>             </div>
              <?php if($product_result['product_process']!=CLOSED){?>
         ...
         <!-- Message flash-->
           ...
           <!-- end of Message flash-->
               ...
               <!-- Self Single Selection  part starts -->
                ...
                <div class="blue_self"  id="lowest_bid_option">
