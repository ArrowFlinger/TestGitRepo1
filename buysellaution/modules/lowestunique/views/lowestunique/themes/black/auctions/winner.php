    ...
    <span class="fl clr mt5"><?php echo $winner_result['country'];
       ...
       // echo __("from_label")." ".$allcountries[$country];?></span>
            ...
            <div class="winners_action_detail_right fl">
                <table width="210" border="0" cellpadding="0" cellspacing="0" style="margin-left:10px;">
                        <tr>
                                <th colspan="2" align="center"><p style="word-wrap:break-word;float:left;text-align:center;width:190px;"><?php echo ucfirst($winner_result['product_name']);?></p></th>
                        </tr>
                        <tr>
                                <td align="right" valign="top" width="80"><label><?php echo __('retail_price_label')?> :</label></td>
                                <td align="left" valign="top"><p><?php echo $site_currency;?> <?php echo $winner_result['product_cost'];?></p></td>
                        </tr>
                        <tr>
                                <td align="right" valign="top" width="84"><label><?php echo __('auction_price_label')?> :</label></td>
                                <td align="left" valign="top"><p><?php echo $site_currency;?> <?php echo Commonfunction::numberformat($winner_result['current_price']);?></p></td>
                        </tr>
                        <tr>
                                <td align="right" valign="top" width="80"><label><?php echo __('savings_label')?> :</label></td>
