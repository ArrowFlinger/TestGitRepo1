...
<div class="action_content_left fl">
        ...
        <div class="action_deal_list  action_deal_list1 clearfix" id="lowest_mybids_page" style="width:690px;">	
       ...
       <table width="660" border="0" align="left" cellpadding="0" cellspacing="0"  class="table-top">
               <thead>
                <tr>
                        ...
                        <th width="160" align="center"><?php echo __('total_bids');?></th>
                        <th width="100" align="center"><?php echo __('auction_paid_price');?></th>
                        <th width="100" align="center"><?php echo __('status_label');?></li>
                </tr>
                </thead>
                ...
                foreach($bidhistories as $bidhistory):?>
                 ...
                 <tr>
                        ...
                        <td width="160" align="center"><p><?php echo  $bidhistory['count('.BID_HISTORIES.'.product_id)'];
                        ?></p></td>
                        <td width="100" align="center"><b style="color:#3d3d3d; font-weight:normal;width:100px; word-wrap:break-word;"><?php echo  $site_currency." ".Commonfunction::numberformat($bidhistory['current_price']);?></b></td>
                        <td width="100" align="center">
