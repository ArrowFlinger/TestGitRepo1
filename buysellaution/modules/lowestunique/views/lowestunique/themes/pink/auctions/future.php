<?php foreach ($productsresult as $product_result): ?>
 ...
 <?php if ($product_result['product_featured'] == FEATURED) { ?><span class="feature_icon"></span><?php } ?>
        ...
        <div class="watch_list  clr">
            <span class="read_more"><a href="<?php echo URL_BASE; ?>auctions/view/<?php echo $product_result['product_url']; ?>" title="<?php echo __('more_info');?>"><?php echo __('more_info');?></a></span>
