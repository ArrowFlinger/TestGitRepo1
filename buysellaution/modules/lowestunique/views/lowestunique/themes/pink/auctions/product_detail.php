...
<div class="product_container clr auction_item" id="auction_<?php echo $id;?>" name="<?php echo URL_BASE;?>auctions/process">
    ...
    <div class="detail-inner clearfix" id="lowest_product_detail_page">
            <div class="match_banner">
				...
				<div style="position:absloute;z-index:999;"> <?php if($product_result['product_featured']==FEATURED){?><span class="feature_label"></span><?php } ?>
				...
				<?php if($product_result['buynow_status']==ACTIVE && $product_result['product_process']!='C'):?>                  
				  <div class="buy-left">
                    ...
                    <div class="share clearfix">
                        ...
                        <ul>
                            <li class="twit" style="width:25px;float:left;"><a href="http://twitter.com/share?url=<?php echo $url;?>&amp;text=<?php echo $product_result['product_name'];?>" target="_blank"  title="Twitter" class="fl">
                                            
                                        </a></li>
                            <li class="face" style="width:25px;float:left;"><a href="https://www.facebook.com/sharer.php?u=<?php echo $url;?>&t=<?php echo $product_result['product_name'];?>" title="Facebook" class="fl" target="_blank">
                                            <img src="<?php echo IMGPATH;?>s3.png" alt="Facebook" border="0" />
                                        </a></li>
                            <li class="flike" style="float:left;width:auto;"><fb:like href="<?php echo $url = URL_BASE.'auctions/view/'.$product_result['product_url'];?>" layout="button_count" width="84" send="false" ref="" style="border:none;"></fb:like></li>
                        </ul>
                    </div> <?php }?>
                </div>
            </div>
