...
?>
	...
	<div class="auction_item_content" name="<?php echo URL_BASE;?>auctions/process">
        ...
        <div class="lowestunique"></div>
            ...
            <span class="read_more" style="margin-top:10px;">   <a href="<?php echo URL_BASE; ?>auctions/view/<?php echo $product_result['product_url']; ?>" title="<?php echo __('more_info');?>"><?php echo __('more_info');?></a></span>
