...
<div class="action_content_left fl" id="lowest_mybids_page">
        ...
        <div class="deal-left clearfix" id="lowest_mybids_page">
			   ...
			   <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0"  class="table_top">
                ...
                foreach($bidhistories as $bidhistory):?>
                 ...
                 <tr>
                       ...
                       <td width="100" align="center">
                       <?php echo $bidhistory['in_auction']!=2?"<a href='".URL_BASE."auctions/view_product_history/".$bidhistory['product_url']."' class='delet_link fr' title='".__('live_text')."'>".__('live_text')."</a>":"<p class='watch_list_time '>".__('closed_text')."</p>";?>
                        </td>
                 </tr>
                <?php endforeach; 
                ?>
