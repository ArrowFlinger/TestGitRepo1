<?php
	...
	<ul> 
                    ...
                    <div class="blue_type_bid1"> <span style="color:#2691C9;font:normal 11px/15px arial;float:left;text-align:center;padding-top:12px;" title="Lowest but not unique" href="#">
                    <?php 
