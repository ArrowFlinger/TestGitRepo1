...
<p><small><?php echo __('Displayed :start-:end of :total', array(':start' => $current_first_item, ':end' => $current_last_item, ':total' => $total_items))?></small></p>
    	...
    	<?php if ($previous_page !== FALSE): ?>
    		<li class="fl">
                  <div class="page_lft fl"></div>
    		<div class="page_mid fl"><a href="<?php echo HTML::chars($page->url($previous_page)) ?>" rel="last" title="Previous"><img src="<?php echo IMGPATH; ?>pagination-right.png" width="5" height="7" alt="next" /></a> </div>
                <div class="page_rgt fl"></div>
            </li>
        <?php else: ?>
    	   <li class="fl">
