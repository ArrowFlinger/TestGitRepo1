...
CREATE TABLE IF NOT EXISTS `TABLE_PREFIX.lowestunique` (
...
INSERT INTO `TABLE_PREFIX.types` (`typeid`, `typename`, `settings`, `pack_type`, `status`) VALUES (NULL, 'lowestunique', 'a:1:{s:7:"adminjs";b:1;}', 'M', 'I'); 
