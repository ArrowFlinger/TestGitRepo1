...
<div class="content_top"><div class="top_left"></div><div class="top_center"></div><div class="top_rgt"></div></div>
        <div class="content_middle" >
                ...
                <form method="POST" class="admin_form" action="<?php echo URL_BASE;?>admin/reserve/reserve_settings/" >
                        <table class="list_table1 fl clr">
                                
                                 <tr>
                                        <td   style="padding:5px 40px;"></td>   
                                        <td>
                                          <input type="checkbox" name="email_verification" value="Y"  <?php echo ($user_setting_data['email_verification_reg']=="Y")?"checked='checked'":"";?>><label><?php echo __('reserveemail_verify_label');?></label>
                                          <p><?php echo __('reserveemail_verify_content');?></p>                                       
                                        </td>                           
                                </tr>
