...
?>
        ...
        <?php foreach($productsresult as $product_result):?>
            <div id="auction_<?php echo $product_result['product_id'];?>" class="auction_item auction_item_content reserve" name="<?php echo URL_BASE;?>auctions/process">
			...
			<div class="soon_link soon-link-future fl">
				...
				*/ ?>
                <div class="bidme_link width_bidme fl">
                        ...
                        <a title="<?php echo __('details_lable'); ?>" href="<?php echo URL_BASE;?>auctions/view/<?php echo $product_result['product_url'];?>"><?php echo __('details_lable'); ?></a>
                        </span>
