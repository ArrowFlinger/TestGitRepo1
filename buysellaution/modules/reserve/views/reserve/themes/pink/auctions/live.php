...
<div class="pop_top_bg">
			 ...
			 <!-- <span class="penny"></span> -->
                ...
                <center>
                        <div class="bidme_link width_bidme width_bidme_live width_bidme_live_reserve clr" style="margin-left:20px">
                ...
                <div class="user" style="display:none;" ><?php //echo $user;?></div>
                  <div class="countdown reserve_bid_countdown fl clr"><img src="<?php echo IMGPATH.'ajax-loader.gif';?>"/></div>
