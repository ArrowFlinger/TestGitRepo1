<?php foreach ($productsresult as $product_result): ?>
    <div id="auction_<?php echo $product_result['product_id']; ?>" class="auction_item auction_item_content reserve" name="<?php echo URL_BASE; ?>auctions/process" data-id="<?php echo $product_result['product_id']; ?>">
        ...
        <div class="deal-mid clearfix">
            ...
            <div class="image-block fl">
                ...
                <div class="action_item_img"> 
                    ...
                    <?php /*<p><?php //echo __("time_countdown_label") . " : " . //$product_result['bidding_countdown']; ?> secs</p> */ ?>
                </div>
                </div>
            ...
            <div class="text-block fl clearfix">
                ...
                <div class="price-block clearfix">
                    ...
                    <div class="bidme_link_out">
                        <center>
                            <div class="bidme_link width_bidme width_bidme_live_reserve clr">
                                <span class="bidme_link_left fl">&nbsp;</span>
                                <span class="bidme_link_middle fl">
                                    <a href="<?php echo url::base();?>auctions/view/<?php echo $product_result['product_url'];?>" title="<?php echo __('bid_me_label');?>" >
    <?php echo __("bid_me_label"); ?>
                ...
                <?php /* <div class="action_bidder_name fl clr">
                ...
                <div class="countdown reserve_bid_countdown"><img src="<?php echo IMGPATH . 'ajax-loader.gif'; ?>"/></div>
