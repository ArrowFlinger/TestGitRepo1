...
<div class="action_content_left fl reserve">
        ...
        <div class="table-mid">
            <div class="table-top" style="width:100%;float:none;">
            <table width="660" border="0" align="left" cellpadding="0" cellspacing="0" class="table-top" style="width:100%;">    
	    <tr>
                ...
                <table width="670" border="0" align="left" cellpadding="0" cellspacing="0" style="width:100%;">
                <?php $i=0;
