 ...
 <div class="detail_big_history_content"><p><?php echo count($bid_histories)." ".__('bids_total');?></p>  </div>
       ...
       <ul>
			<?php $j=0; $i=0;foreach($bid_histories as $bid_history):?>
				<?php if($j < 6){ ?>
					<li> <div class="winning_list_left"><h1><?php echo $bid_history['bidder_name'];?></h1> <p><?php echo $bid_history['date'];?></p>  </div> <div class="winning_list_right"><p><?php echo $site_currency." ".number_format($bid_history['price'], 2, '.', '');$j++; ?></p>  </div>  </li>
				<?php } ?>
			<?php endforeach;?>
