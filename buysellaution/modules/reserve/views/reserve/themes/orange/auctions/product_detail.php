...
<!-- winning msg / outbid msg -->
    ...
    <div class="product_container re_product_container clr mt15 auction_item" id="auction_<?php echo $id;?>" name="<?php echo URL_BASE;?>auctions/process">
	...
	<div class="clear"></div>
		...
		<!--Lightbox link-->
               ...
               <div class="price-container fl">
                        ...
                        <ul class="timer-list">
                        <li class="roming"><p class="fl" style="font-size:12px; font-weight:bold;color:#000; text-align:center;"><?php echo __('price_label');?> :</p><p class="fl"  style="font-size:14px; font-weight:bold;"><span class="currentprice" style="color:#2791C1;"><?php echo ($product_result['product_process']==CLOSED)? $site_currency." ".$product_result['current_price']:$site_currency." ".$product_result['current_price'];?></span><span class="price" style="display:none;"></span></p></li>
					  ...
					  if($product_result['product_process']==LIVE){?>
							...
							<div class="hb_place_bid_tb" >
							 <form method="post" id="reserve_form">
								<div class="fl"><span style="float:left;margin:7px 0 0 0;" ><?php echo $site_currency; ?>&nbsp;</span><input type="text" name="bidamount" id="yourbidding" class="savetext" value="" style="border:1px solid #ccc;" /><input type="hidden"  id="currency" class="savetext" value="<?php echo $site_currency;?>" /><p style="font: normal 11px arial;"><?php echo __("enter_amt_lable"); ?></p></div>
								</form>
							</div> 
						</div>
					<?php } //end ?>
   ...
   document.getElementById('fade1').style.display='none'"><?php echo __('close_lable'); ?></a>
                                            </div>
                                        </div>
                                    </div>
