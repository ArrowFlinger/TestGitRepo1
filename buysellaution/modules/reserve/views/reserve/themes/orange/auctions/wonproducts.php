...
<div class="content_left_out content_left_out1 fl reserve">
        ...
        <div class="action_deal_list action_deal_list1 clearfix">	
            <div class="won_action_items won_action_items1 clearfix" style="padding-left:6px;">
       ...
       <?php $i=0;
		...
		<tr>
		<td align="center" width="70"><a href="<?php echo url::base();?>auctions/view/<?php echo $won_result['product_url'];?>"><?php 
		...
		<td width="100" align="center" class="<?php echo $bg_none;?>"><p ><?php echo Text::limit_chars(ucfirst($won_result['product_name']),12);?></p></td>

		<td width="100" align="center" class="<?php echo $bg_none;?>"><p><?php echo  $won_result['enddate'];?></p></td>
		<td width="100" align="center" class="<?php echo $bg_none;?>"><b style="color:#333;width:100%;"><?php echo  $site_currency." ".$won_result['amountpay'];?></b></td>
