...
<div class="title-left title_temp1">
        ...
        <div class="title-mid">
  <p><?php echo __('checkout_label');?></p>
        </div>
        </div>
        </div>
	...
	<?php }?>
			...
			?>
                        <tr>
                            ...
                            <td width="150" align="center" style="border-top:1px solid #F0F0F0;border-bottom:1px solid #F0F0F0;"><span>
			    <?php
			...
			?>
                    ...
                    <div class="fr right_price_details">
                        <div class="right_price1" style="width:740px;">
                            <p><?php echo __('shipping_handing'); ?></p>
                        </div>
                        <div class="right_price2" style="width:165px;"><b><?php echo $site_currency." ".Commonfunction::numberformat($sfee);?>  </b></div>
                    </div> 
                    <!--Total_price-->
                    <div class="fr right_price_details2">
                        <div class="right_price12" style="width:740px;"> <b><?php echo __('grand_total'); ?></b> </div>
                        <div class="right_price22" style="width:165px;"><b><?php
