...
<form method="post" action=""> 
        ...
        <div class="watch_list_items watch_list_items2 trans_watch_list_items watch_list_items5 fl clr" style="width:935px;">	
	...
	<tr class="white_font">	
                <th width="130"  align="center"><b style="font-weight:bold;"><?php echo __('product_image');?></b></th>
		<th width="200" align="center"><b style="font-weight:bold;"><?php echo __('product_name');?></b></th>
		<th width="200" align="center"><b style="font-weight:bold;"><?php echo __('product_amount');?></b></th> 			
		<th width="200" align="center"><b style="font-weight:bold;"><?php  echo __('quantity_label');?></b></th>
		<th width="200" align="center"><b style="font-weight:bold;"><?php echo __('sub_total_label'); ?></b></th> 
		<th width="200" align="center"><b style="font-weight:bold;"><?php  echo __('remove_label');?></b></th>		
	</tr>
        </table>
        </div>
        </div>
	...
	?>
        <tr>
            <td align="center" width="130"  class="<?php echo $bg_none;?>"><p>	
		<?php 
		...
		<div class="img_bg">
                ...
                <td width="200" align="center" class="<?php echo $bg_none;?>"><span class="mail_link" style="display:block; padding:0 0 0 0px;"><?php echo ucfirst($transaction['product_name']);?></span></td>
		 
               
                <td align="center"  width="200" class="<?php echo $bg_none;?>">
		<p style="color:#D90184; font-weight:bold; text-align:center;">
		<?php echo $site_currency." ".Commonfunction::numberformat($transaction['product_cost']);?></p></td>
		...
		<p style="color:#D90184;">
		 ...
		 <td align="left" width="200"  class="<?php echo $bg_none;?>"><p  class="watch_list_time">
                         
<a s onclick="frmdel(<?php echo $transaction['id'];?>);"  class="remove_card_icon"title="<?php echo __('remove_label');?> "> </a></p>
                </td>
  ...
  <div class="continue_shopping_rft"></div>
	...
	<div class="total_amt">
		...
		<div class="total_amt_innr" style="width:960px;float:left;">
		<b style="width:730px;text-align:right;float:left;"><?php  echo __('shipping_handing'); ?> </b>
		<span style="width:180px;text-align:left;float:left;padding-left:10px;"><?php
				$totalamount= array_sum($tamount);
				echo $site_currency . " " . Commonfunction::numberformat($sfee); ?></span></div></div>

<div class="total_amt">
		
		<div class="total_amt_innr" style="width:960px;float:left;">
		<b style="width:730px;text-align:right;float:left;"><?php echo __('grand_total'); ?> </b>
		<span style="width:180px;text-align:left;padding-left:10px;float:left;"><?php
   $totalamount= array_sum($tamount)+$sfee;
    echo $site_currency . " " . Commonfunction::numberformat($totalamount); ?></span></div></div>
	</div>
		
	<div class="check_out fr" style="width:20%;">
