...
<!--container left start-->
   ...
   <h4 style="margin-left:15px;color:#333333;font-size:16px;border-bottom:1px dotted #666666"><?php echo __('buynow_offline_title_lable');?></h4> 
...
echo __('you_are_purchasing',array(':param'=>"<b>".$trans["product_name"]."</b>",':param1'=>"<b>".$site_currency." ".Commonfunction::numberformat($product_cost)."</b>"));?>  </div>
