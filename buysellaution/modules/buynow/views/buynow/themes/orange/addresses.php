 ...
 <div id="content-3" class="content pink_product_box_outer" style="display: none;display: none; background: #fff; margin-top:-13px;width:926px;">
			...
			?>
                    ...
                    <div class="fr right_price_details">
                        ...
                        <div class="right_price2" style="width:170px;"><b><?php echo $site_currency." ".Commonfunction::numberformat($sfee);?>  </b></div>
                    </div> 
                    <!--Total_price-->
                    <div class="fr right_price_details2">
                        <div class="right_price12" style="width:740px;"> <b><?php echo __('grand_total'); ?></b> </div>
                        <div class="right_price22" style="width:170px;"><b><?php
			...
			<?php /*	<a style="color:#000;" href="<?php echo URL_BASE;?>site/buynow/buynow_auction/<?php echo $trans['userid'];?>" title="<?php echo __('pay_label');?>"><?php echo __('pay_label');?></a> */ ?>
