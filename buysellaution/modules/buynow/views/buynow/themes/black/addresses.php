...
<div class="title_temp2 fl clr">
    	<h2 class="fl clr" title="<?php echo __('checkout_label');?>"><?php echo __('checkout_label');?></h2>
            ...
            <div class="watch_list_items roling clr fl" style="width:961px;"> 
...
<div id="content-1" class="content pink_product_box_outer "  style="display: none; background: #444; margin-top:-10px;width:923px;height:600px; border:1px solid #4F4F4F; border-top:0;">	
       <div id="pass">
	...
	<?php } else{ ?>
		<div class="add_bill_address fl ml20" style="margin-top:10px; padding-bottom: 20px">
...
<div id="content-2" class="content pink_product_box_outer" style="display: none; background: #444; margin-top:-10px;width:923px; border:1px solid #4F4F4F; border-top:0;">
	...
	<?php }else{ ?>
		<div class="add_bill_address fl" style="margin:20px 0 0 20px; padding-bottom: 10px">
		<span class="add_address_left fl">&nbsp;</span>
	...
	<?php }?>
             ...
             <div class="billing_information_pink2_outer">
                ...
                <div id="content-3" class="content pink_product_box_outer" style="display: none; background: #444;padding: 10px 10px; margin-top:-10px;width:903px ; border:1px solid #4F4F4F; border-top:0;">
                    <table class="pink_product_box fl clr" cellpadding="0" cellspacing="0" style="border:none;width:890px!important">
                        ...
                        <tr>
                            <th width="600" align="left" style="border-top:1px solid #3A3A3A;border-bottom:1px solid #3A3A3A;color:#3A3A3A;"><b style="margin-left:30px;"><?php echo __('product_name');?></b></th>
                            <th width="110" align="center" style="border-top:1px solid #3A3A3A;border-bottom:1px solid #3A3A3A;color:#3A3A3A;"><b><?php echo __('product_cost_label');?></b></th>
                            <th width="70" style="border-top:1px solid #3A3A3A;border-bottom:1px solid #3A3A3A; color:#3A3A3A;" align="center"><b><?php echo __('quantity_label');?></b></th>
			    
                            <th style="border-top:1px solid #3A3A3A;border-bottom:1px solid #3A3A3A; color:#3A3A3A;" width="80" align="center"><b><?php echo __('sub_total_label');?></b></th>
                        </tr>
			 <?php
			 $i=0;
			 $sfee=0;
			...
			?>
                        <tr>
                            <td width="450" align="left" style="border-top:1px solid #3A3A3A;border-bottom:1px solid #3A3A3A;color:#FFF;"><p style="width:174px;"><?php echo ucfirst($trans['product_name']);?></p></td>
                            <td width="200" align="center" style="border-top:1px solid #3A3A3A;border-bottom:1px solid #3A3A3A;color:#FFF;"><p><?php echo $site_currency." ".Commonfunction::numberformat($trans['product_cost']);?></p></td>
                            <td width="200" align="center" style="border-top:1px solid #3A3A3A;border-bottom:1px solid #3A3A3A;"><p><?php echo $trans['quantity'];?></p></td>
                         
                            
			    <td width="200" align="center" style="border-top:1px solid #3A3A3A;border-bottom:1px solid #3A3A3A;"><span>
			    <?php
			...
			?>
                    ...
                    <div class="fr right_price_details" style="color:#FFF;">
                        <div class="right_price1" style="color:#FFF;width:750px;*width:765px;text-align:right;">
                            <p ><?php  echo __('shipping_handing'); ?></p>
                        </div>
                        <div class="right_price2" style="color:#FFF;width:137px;*width:120px;text-align:left;float:left;padding-left:12px;"><b><?php echo $site_currency." ".Commonfunction::numberformat($sfee);?> </b></div>
		    </div> 
                    <!--Total_price-->
		    
		     <div class="fr right_price_details" style="color:#FFF;">
                        <div class="right_price1" style="color:#FFF;width:750px;*width:765px;text-align:right;">
                            <p ><?php echo __('grand_total'); ?></p>
                        </div>
                        <div class="right_price2" style="color:#FFF;width:137px;*width:120px;text-align:left;float:left;padding-left:12px;"><b><?php echo $site_currency." ".Commonfunction::numberformat($subamtadd+$sfee);?> </b></div>
		    </div>
