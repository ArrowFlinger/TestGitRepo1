    ...
    <div class="content_middle">
        <form method="post" class="admin_form" name="frmcontactreq" id="frmcontactreq">
			...
			<!--** payment transaction log Listings Starts Here ** -->
                ...
                <td align="center">
                <?php echo '<a href="'.URL_BASE.'admin/buynow/show_payment_log/'.$all_payment_transaction['PRODUCTID'].' " style="float:none; display:block;" target="_blank" title ='.__('view').' class="viewicon"></a>' ; ?>
