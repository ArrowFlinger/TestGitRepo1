...
<div class="title-left title_temp2">
        ...
        <div class="title-mid">
                <h2 class="fl clr" title="<?php echo __('Checkout');?>"><?php echo __('Checkout');?></h2>
...
<div class="billing_information_pink2_outer" style="margin-top:10px;">
                ...
                <div id="content-3" class="content pink_product_box_outer" style="display: none; margin-top:-20px;background:#fff; border-bottom:1px solid #ddd;">
                    <table class="pink_product_box fl clr" style="border:none;width:926px" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <th width="100" align="center" style="border-top:1px solid #F0F0F0;border-bottom:1px solid #F0F0F0;"><b><?php echo __('product_cost_label');?></b></th>
                            <th width="60" style="border-top:1px solid #F0F0F0;border-bottom:1px solid #F0F0F0;" align="center"><b><?php echo __('quantity_label');?></b></th>
                            <th style="border-top:1px solid #F0F0F0;border-bottom:1px solid #F0F0F0;" width="60" align="right" ><b style="text-align:right;float:right;width:60px;*margin-left:30px;"><?php echo __('sub_total_label');?></b></th>
                        </tr>
			...
			?>
                        <tr>
                            ...
                            <td width="70" align="center" style="border-top:1px solid #F0F0F0;border-bottom:1px solid #F0F0F0;"><p><?php echo $trans['quantity'];?></p></td>
                            <td width="90" align="right" style="border-top:1px solid #F0F0F0;border-bottom:1px solid #F0F0F0;"><span style="text-align:right;"><?php echo $site_currency." ".Commonfunction::numberformat($subamount);?></span></td>
                        </tr>                        
			<?php endforeach; ?>
                    </table>
                    <!--price_details1-->
