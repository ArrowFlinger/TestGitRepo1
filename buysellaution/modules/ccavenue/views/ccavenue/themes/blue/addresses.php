...
<div class="title-left title_temp1">
        ...
        <div class="title-mid">
   <?php /*?>     <h2 class="fl clr pl10" title="<?php echo __('menu_buynow_transaction');?>"><?php echo __('menu_buynow_transaction');?></h2><?php */?><p>checkout</p>
        </div>
        </div>
        </div>
    <div class="watch_list_items yars clr fl" style="padding-left:15px;">
                ...
                <div id="content-1" class="content pink_product_box_outer "  style="display: none; background: #fff; margin-top:-16px;width:926px;">
		       <div id="pass">
<?php if(count($db_values)>0){?>
	...
	<?php } else{ ?>
        <div class="add_bill_address fl ml20" style="margin-top:20px;padding-bottom: 20px;">
	...
	<?php }?>
                ...
                <div id="content-2" class="content pink_product_box_outer" style="display: none;display: none; background: #fff; margin-top:-16px;width:907px;padding: 10px 10px;">
                   <div id="pass">
<?php if(count($db_values_shipping)>0){ ?>
	...
	<?php }else{ ?>
		<div class="add_bill_address fl" style="margin-top:20px;padding-bottom: 20px">
		<span class="add_address_left fl">&nbsp;</span>
		<span class="add_address_middle fl">
	...
	<?php }?>
             ...
             <div class="billing_information_pink2_outer">
                ...
                <div id="content-3" class="content pink_product_box_outer" style="display: none;display: none; background: #fff; margin-top:-13px;width:926px;">
                    <table class="pink_product_box fl clr"  cellpadding="0" cellspacing="0" style="width:926px !important; border:none; ">
                        ...
                        <tr>
                            <th width="400" align="left" style="border-top:1px solid #F0F0F0;border-bottom:1px solid #F0F0F0;"><b style="margin-left:30px;"><?php echo __('product_name');?></b></th>
                            <th width="110" align="center" style="border-top:1px solid #F0F0F0;border-bottom:1px solid #F0F0F0;"><b><?php echo __('product_cost_label');?></b></th>
                            <th width="70" style="border-top:1px solid #F0F0F0;border-bottom:1px solid #F0F0F0;" align="center"><b><?php echo __('quantity_label');?></b></th>
                            <th style="border-top:1px solid #F0F0F0;border-bottom:1px solid #F0F0F0;" width="40" align="center"><b><?php echo __('sub_total_label');?></b></th>
                        </tr>
			...
			?>
                        <tr>
                            <td width="600" align="left" style="border-top:1px solid #F0F0F0;border-bottom:1px solid #F0F0F0;"><p style="margin-left:30px;width:199px;"><?php echo ucfirst($trans['product_name']);?></p></td>
                            <td width="130" align="center" style="border-top:1px solid #F0F0F0;border-bottom:1px solid #F0F0F0;"><p style="width:200px;"><?php echo $site_currency." ".Commonfunction::numberformat($subamount);?></p></td>
                            <td width="90" align="center" style="border-top:1px solid #F0F0F0;border-bottom:1px solid #F0F0F0;"><p><?php echo $trans['quantity'];?></p></td>
                            <td width="90" align="center" style="border-top:1px solid #F0F0F0;border-bottom:1px solid #F0F0F0;"><span><?php echo $site_currency." ".Commonfunction::numberformat($subamount);?></span></td>
                        </tr>                        
			<?php endforeach; ?>
                    </table>
                    <!--price_details1-->
                    <div class="fr right_price_details">
                        <div class="right_price1">
                            <p><?php echo __('price_label');?></p>
                        </div>
                        <div class="right_price2"><b><?php echo $site_currency." ".Commonfunction::numberformat($totalamount);?> </b></div>
                    </div>
                    <!--price_details2-->
                    <div class="fr right_price_details">
                        <div class="right_price1">
                        ...
                        <div class="right_price2"><b>$0.00 </b></div>
                    </div>
                    <!--price_details3-->
                    <div class="fr right_price_details">
                        <div class="right_price1">
                    ...
                    <div class="fr right_price_details2">
                        <div class="right_price12"> <b><?php echo __('grand_total'); ?></b> </div>
                        <div class="right_price22"><b><?php echo $site_currency." ".Commonfunction::numberformat($totalamount);?> </b></div>
                    </div>
                </div>
              
                <div class="action_deal_list_btm_rft" style="margin-top:20px;"><div class="one_left"><p><?php echo __('forgot_an_label');?><a href="<?php echo URL_BASE;?>site/buynow/addtocart_list" title="<?php echo __('edit_cart_label');?>"> <?php echo __('edit_cart_label');?></a></p></div>
