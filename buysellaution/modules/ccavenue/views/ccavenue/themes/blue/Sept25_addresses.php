...
<div class="title-left title_temp1">
        ...
        <div class="title-mid">
   <?php /*?>     <h2 class="fl clr pl10" title="<?php echo __('menu_buynow_transaction');?>"><?php echo __('menu_buynow_transaction');?></h2><?php */?>
        </div>
        </div>
        </div>
 ...
 <div id="content-1" class="content pink_product_box_outer "  style="display: none; background: #fff; margin-top:-6px;width:907px;padding: 10px 10px;">
       <div id="pass">
...
<div id="content-2" class="content pink_product_box_outer" style="display: none">
        <div id="pass">
	...
	<?php }?>
             ...
             <div class="billing_information_pink2_outer">
                ...
                <div id="content-3" class="content pink_product_box_outer" style="display: none">
                    <table class="pink_product_box fl clr">
			
                        <tr>
                            <th width="600" align="left" style="border-top:1px solid #F0F0F0;border-bottom:1px solid #F0F0F0;"><b style="margin-left:30px;">Product Name</b></th>
                            <th width="110" align="center" style="border-top:1px solid #F0F0F0;border-bottom:1px solid #F0F0F0;"><b>Product Cost</b></th>
                            <th width="70" style="border-top:1px solid #F0F0F0;border-bottom:1px solid #F0F0F0;" align="center"><b>Quantity</b></th>
                            <th style="border-top:1px solid #F0F0F0;border-bottom:1px solid #F0F0F0;" width="40" align="center"><b>Sub Total</b></th>
                        </tr>
			...
			<?php endforeach; ?>
                ...
                <div class="action_deal_list_btm">
                    <!--<div class="action_deal_list_btm_lft">
                        <p>Forgot an Item? <a href="#" title="Edit Your Cart">Edit Your Cart</a></p>
                    </div>-->
