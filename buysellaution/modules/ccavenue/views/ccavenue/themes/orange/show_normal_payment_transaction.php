       ...
       <form method="post" enctype="multipart/form-data" class="admin_form" name="frmlog" id="frmlog">
			...
			if($total_count > 0){ ?>
				...
				<?php echo ($page_data['PAYERID'])?$page_data['PAYERID']:"-";?>
                         ...
                         <tr>
                         <td valign="top"><label><?php echo __('fees_no_label'); ?></label></td>
                            	<td>
				<?php echo ($page_data['FEEAMT'])?$page_data['PAYERID']:"-";?>
                             </td>
                        </tr> 
                         <tr>
                         <td valign="top"><label><?php echo __('amount_label',array(':param'=>$site_settings[0]['site_paypal_currency'])); ?></label></td>
                            	<td>
