...
<div class="action_content_left real fl">
		...
		<!--List products-->
        <div class="table-left" style="width:940px">
        <div class="table-right" style="width:940px;">
        <div class="table-mid" style="width:930px">		
            <table width="940" border="0" align="left" cellpadding="0" cellspacing="0"  class="table-top" style="width:930px!important;">
                <tr>
                        ...
                        <th  align="center"><b><?php echo __('product_info');?></b></th>
                ...
                <table width="660" border="0" align="left" cellpadding="0" cellspacing="0" style="width:940px!important;" >
        <?php 
		...
		<?php if($transaction['amount_type'] == DEBIT){ ?>
		 <a href="<?php echo URL_BASE;?>site/buynow/show_payment_log/<?php echo $transaction['product_id'];?>"><?php echo ucfirst($transaction['product_name']);?></a><?php }else{   echo ucfirst($transaction['product_name']); } ?> 
                ...
                <td align="center" class="<?php echo $bg_none;?>"><p ><?php echo $transaction['description']!=""?ucfirst($transaction['description']):"--";?></p></td>
                <td align="center" width="212" class="<?php echo $bg_none;?>"><p><?php echo $site_currency." ".Commonfunction::numberformat($transaction['amount']);?></p></td>
