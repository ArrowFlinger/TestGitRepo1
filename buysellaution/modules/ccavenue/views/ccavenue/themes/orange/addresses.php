...
<div class="action_deal_list1  forwod clearfix">

            <div class="watch_list_items for  clr fl">
...
<div id="content-1" class="content pink_product_box_outer "  style="display: none; margin-top:-10px;border-bottom:1px solid #ddd; width:907px;padding:10px; background: #fff;">	
       <div id="pass">
...
<div id="content-2" class="content pink_product_box_outer" style="display: none; margin-top:-10px; width:907px;border-bottom:1px solid #ddd;padding:10px; background: #fff;">
        <div id="pass">
	...
	<?php }?>
             ...
             <div class="billing_information_pink2_outer">
                ...
                <div id="content-3" class="content pink_product_box_outer" style="display: none;border-bottom:1px solid #ddd; margin-top:-10px; width:907;padding:10px; background: #fff;">
                    <table  class="pink_product_box fl clr">
			
                        <tr>
                            <th width="600" align="left" style="border-top:1px solid #F0F0F0;border-bottom:1px solid #F0F0F0; "><b style="margin-left:30px;"><?php echo __('product_name');?></b></th>
			...
			?>
                        <tr>
                            <td width="600" align="left" style="border-top:1px solid #F0F0F0;border-bottom:1px solid #F0F0F0;"><p style="margin-left:30px;"><?php echo ucfirst($trans['product_name']);?></p></td>
                            <td width="130" align="center" style="border-top:1px solid #F0F0F0;border-bottom:1px solid #F0F0F0;"><p><?php echo $site_currency." ".Commonfunction::numberformat($subamount);?></p></td>
			...
			<?php endforeach; ?>
				...
				<a style="color:#000;" href="<?php echo URL_BASE;?>site/buynow/buynow_offline/<?php echo $trans['userid'];?>" title="<?php echo __('pay_label');?>"><?php echo __('pay_label');?></a>
				<?php	}else{ ?>
				<a style="color:#000;" href="<?php echo URL_BASE;?>site/buynow/buynow_auction/<?php echo $trans['userid'];?>" title="<?php echo __('pay_label');?>"><?php echo __('pay_label');?></a>
