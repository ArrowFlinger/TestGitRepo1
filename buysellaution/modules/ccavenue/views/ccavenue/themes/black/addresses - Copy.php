...
<div class="title_temp2 fl clr">
    	<h2 class="fl clr" title="<?php echo __('view_news');?>"><?php echo __('view_news');?></h2>
            ...
            <div class="watch_list_items roling clr fl">
                ...
                <div class="billing_information_pink2_outer">
                    <div class="billing_information_pink">
                        ...
                        <div class="billing_information_mid">
                            <div class="billing_information_mid_inner" style="color:#FFF;">
...
<div id="content-1" class="content pink_product_box_outer "  style="display: none; background: #444; margin-top:-10px;width:923px; border:1px solid #4F4F4F; border-top:0;">	
       <div id="pass">
	<?php if(count($db_values)>0){?>
       ...
       <div class="row_colm1 fl clr mt20">
        ...
        <!--Country-->
        <div class="row_colm1 fl clr mt20">
                <div class="colm1_width fl"><p>hi<?php echo __('country_label');?> <span class="red">*</span>:</p></div>
                <div class="colm2_width fl">
                        <div class="selectbox_out inputbox_out fl" style="width:371px;height:17px;">
	                        <span class="select" style="width:371px;height:17px;"><?php $selected= isset($form_values['country'])?$form_values['country']:$db_values[0]['country'];?></span>
                        <?php 
...
<div id="content-2" class="content pink_product_box_outer" style="display: none; background: #444; margin-top:-10px;width:923px; border:1px solid #4F4F4F; border-top:0;">
        <div id="pass">
	...
	<?php }else{ ?>
		...
		<span class="add_address_left fl">&nbsp;</span>
		<span class="add_address_middle fl" style="color:#FFF;">
	...
	<?php }?>
             ...
             <div class="billing_information_pink2_outer">
                    <div class="billing_information_pink2">
                        ...
                        <div class="billing_information_mid2">
                            <div class="billing_information_mid_inner2" style="color:#FFF;">
                ...
                <div id="content-3" class="content pink_product_box_outer" style="display: none; background: #444;padding: 10px 10px; margin-top:-10px;width:903px ; border:1px solid #4F4F4F; border-top:0;">
                    <table class="pink_product_box fl clr" cellpadding="0" cellspacing="0" style="border:none;width:890px!important">
			
                        <tr>
                            <th width="600" align="left" style="border-top:1px solid #3A3A3A;border-bottom:1px solid #3A3A3A;color:#3A3A3A;"><b style="margin-left:30px;">Product Name</b></th>
                            <th width="110" align="center" style="border-top:1px solid #3A3A3A;border-bottom:1px solid #3A3A3A;color:#3A3A3A;"><b>Product Cost</b></th>
                            <th width="70" style="border-top:1px solid #3A3A3A;border-bottom:1px solid #3A3A3A; color:#3A3A3A;" align="center"><b>Quantity</b></th>
                            <th style="border-top:1px solid #3A3A3A;border-bottom:1px solid #3A3A3A; color:#3A3A3A;" width="40" align="center"><b>Sub Total</b></th>
                        </tr>
			...
			?>
                        <tr>
                            <td width="600" align="left" style="border-top:1px solid #3A3A3A;border-bottom:1px solid #3A3A3A;color:#FFF;"><p style="margin-left:30px;"><?php echo ucfirst($trans['product_name']);?></p></td>
                            <td width="130" align="center" style="border-top:1px solid #3A3A3A;border-bottom:1px solid #3A3A3A;color:#FFF;"><p><?php echo $site_currency." ".Commonfunction::numberformat($subamount);?></p></td>
                            <td width="90" align="center" style="border-top:1px solid #3A3A3A;border-bottom:1px solid #3A3A3A;"><p><?php echo $trans['quantity'];?></p></td>
                            <td width="90" align="center" style="border-top:1px solid #3A3A3A;border-bottom:1px solid #3A3A3A;"><span><?php echo $site_currency." ".Commonfunction::numberformat($subamount);?></span></td>
                        </tr>                        
			<?php endforeach; ?>
                    </table>
                    <!--price_details1-->
                    <div class="fr right_price_details">
                        <div class="right_price1" style="color:#FFF;">
                            <p><?php echo __('price_label');?></p>
                        </div>
                        <div class="right_price2" style="color:#FFF;"><b><?php echo $site_currency." ".Commonfunction::numberformat($totalamount);?> </b></div>
                    </div>
                    <!--price_details2-->
                    <div class="fr right_price_details" style="color:#FFF;">
                        <div class="right_price1" style="color:#FFF;">
                            <p><?php echo __('shipping_handing_free'); ?></p>
                        </div>
                        <div class="right_price2" style="color:#FFF;"><b>$0.00 </b></div>
                    </div>
                    <!--price_details3-->
                    <div class="fr right_price_details">
                        <div class="right_price1" style="color:#FFF;">
                            <p><?php echo __('used_shopping_credits'); ?></p>
                        </div>
                        <div class="right_price2" style="color:#FFF;"><b>$0.00 </b></div>
                    </div>
                    <!--Total_price-->
                    <div class="fr right_price_details2">
                        <div class="right_price12" style="color:#FFF;"> <b><?php echo __('grand_total'); ?></b> </div>
                        <div class="right_price22" style="color:#FFF;"><b><?php echo $site_currency." ".Commonfunction::numberformat($totalamount);?> </b></div>
                    </div>
                </div>

                <div class="action_deal_list_btm">
                    <div class="action_deal_list_btm_lft">
                        <p>Forgot an Item? <a href="<?php echo URL_BASE;?>site/buynow/addtocart_list" title="Edit Your Cart">Edit Your Cart</a></p>
                    </div>
                    <div class="action_deal_list_btm_rft" style="margin-top:10px;">
                        <div class="place_order_lft"></div>
                        <div class="place_order_mid"> 
				<?php 
				if($useramount > $trans['amount']){ ?>

				<a href="<?php echo URL_BASE;?>site/buynow/buynow_offline/<?php echo $trans['userid'];?>" title="<?php echo __('pay_label');?>"><?php echo __('pay_label');?></a>
				<?php	}else{ ?>
				<a href="<?php echo URL_BASE;?>site/buynow/buynow_auction/<?php echo $trans['userid'];?>" title="<?php echo __('pay_label');?>"><?php echo __('pay_label');?></a>
