...
<form method="post" action=""> 
                            ...
                            <div class="tab_one_top1">
                                ...
                                foreach ($transactions as $transaction):
                                    ...
                                    <div class=" <?php echo $bg_none; ?>"  style="clear:both; float:left; margin-top:10px;width:100%;">
                                        ...
                                        <div class="inner_one_top">
                                            <h5 class="<?php echo $bg_none; ?>"><p><?php echo $site_currency . " " . Commonfunction::numberformat($transaction['amount']); ?></p></h5>
                                        </div>
        ...
        ?>		
                                  ...
                                  <div class="tab_one_top3">
                                    <div class="ta_right">
                                        ...
                                        <div class="inner_tab_left">
                                            <div class="new_left"></div>
                                            <div class="new_mid" style="width:210px;padding: 0px;margin:0px;"> <input type="submit" style="margin:5px 0 0 0px; padding:0px;width:210px" name="update" title="<?php echo __('button_update_shopping_cart'); ?>"  value="<?php echo __('button_update_shopping_cart'); ?>" /></div>
                                            <div class="new_right"></div>
                                        </div>
                                    </div>
    ...
    endforeach;
    ?><?php echo $site_currency . " " . Commonfunction::numberformat($totalamount); ?></label>
                                        <h4><?php echo __('grand_total'); ?></h4>
                                    </div>
                                ...
                                <div class="tab_one_top3">
                                    <div class="yell_one">
                                        ...
                                        <div class="ye_mid"><a href="<?php echo URL_BASE; ?>site/buynow/myaddresses"> <input type="button" title="<?php echo __('check_out'); ?>"  value="<?php echo __('check_out'); ?>"/></a></div>
