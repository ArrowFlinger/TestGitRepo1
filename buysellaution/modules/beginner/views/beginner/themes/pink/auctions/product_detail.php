  ...
  <div class="product_container fl clr ml10 mt20 auction_item" id="auction_<?php echo $id;?>" name="<?php echo URL_BASE;?>auctions/process">
      ...
      <div class="product_left  ml10 fl">
        ...
        <div class="product_content_middle fl clr">
          <div class="product_detail_top fl clr">
            <div class="product_detail_top_left bfl">
              <div class="product-tl">
                <div class="product-tr">
                  <div class="product-tm"> </div>
                </div>
              </div>
              <div class="product-middle bc2c2  clearfix">
                ...
                <span class="feature_icon_product"></span>
                <?php } ?>
                     
                <?php if($product_result['dedicated_auction']==ENABLE){?>
                <span class="bonus_icons_product" title=""></span>
                <?php } ?>
                <?php if($product_result['autobid']==ENABLE){?>
                <span class="autobid_icon"></span>
                <?php } ?>
                <?php if($product_result['product_featured']==HOT){?>
                <span class="hot_icon_product"></span>
                <?php } ?>
                <span class="beginner_big"></span>
                 </div>
                <div id="welcomeHero" class="clearfix" style="height:391px; padding:0 0 0 3px;">
                  <div id="slideshow-main">
                    <ul>
                      <li class="p1 active"> <a class="fl lightbox" title="<?php echo ucfirst($product_result['product_name']);?>"> <img src="<?php echo $product_full_size;?>" width="361" height="285" border="0" class="fl" />
                        <?php if($product_result['lastbidder_userid']!=0 && $product_result['product_process']==CLOSED){?>
                        <img src="<?php echo IMGPATH.SOLD_IMAGE;?>"class="sold_image"/>
                        <?php } ?>
                        </a> </li>
				 ...
				 else
				 {
                                        ...
                                        foreach($productimage_count as $productallname)
				        {
				                ...
				                ?>
                      <li class="p<?php echo $j;?> "> <a href="#"> <img src="<?php echo $product_fullimage_size;?>" width="370" height="284" alt=""/> </a> </li>
                      <?php
				                $j++;
				        }
				}
				 ...
				 else
				 {
                                        ...
                                        $j=2;
                                                ...
                                                ?>
                      <li><a href="#" rel="p<?php echo $j;?>"><img src="<?php echo $product_fullimage_size;?>" width="73" height="64" alt="#"/></a></li>
                      <?php
                                                $j++;}
                                }
                                ?>
                ...
                <div class="product_detail_middle_left">
                  ...
                  <?php if($product_result['product_process']!=CLOSED){?>
                  <div class="add_watch_list pl5">  </div>
                  <?php } ?>
                  <!--Lightbox link-->
                </div>
              </div>
            ...
            <div class="product_detail_top_right fl ml10">
              <div class="price-container">
                
                <div class="price-middle price_middle2 clearfix">
                  <table width="290" cellpadding="0" cellspacing="0" border="0" align="right" class="fl value-table1">
                    <tr>
                      ...
                      <td align="left" style="color:#ed0493;"><p><span class="currentprice" style="color:#ed0493;"><?php echo ($product_result['product_process']==CLOSED)? $site_currency." ".Commonfunction::numberformat($product_result['current_price']):Commonfunction::numberformat($product_result['current_price']);?></span><span class="price" style="display:none;"></span></p></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <div class="product_timer fl"> <strong class="countdown"><?php echo ($product_result['product_process']!=CLOSED)?"<img src=".IMGPATH."ajax-loader.gif>":__('closed_text');?></strong> </div></td>
                    </tr>
                    <tr>
                      <td align="right" colspan="2"><?php if($product_result['startdate']<=$c_date && $product_result['auction_process']!=HOLD):?>
                        <div class="product_bidnow_link fl"> <span class="bidme_link_left bidme_link_left1 fl">&nbsp;</span>
                          <div class="product_bidnow_middle bidme_link_middle bidme_link_middle1 fl">
                            <?php if($product_result['product_process']==LIVE){?>
                            <a href="javascript:;" name="<?php echo URL_BASE;?>auctions/bid" class="bid" title="<?php //echo $error;?>"   rel="<?php echo URL_BASE;?>users/login/"  id="<?php echo $product_result['product_id'];?>" data-auctiontype="<?php echo $product_result['auction_type'];?>"><?php echo __('bid_me_label');?></a>
                            <?php }else if($product_result['product_process']==CLOSED){ ?>
                            <span id="link_<?php echo $product_result['product_id'];?>"  class="future auction_link"><?php echo __('closed_text');?></span>
                            <?php } else if($product_result['product_process']==FUTURE) { ?>
                            <span style="display:none;" class="comingsoon future"><?php echo __('comingsoon_text');?></span>
                            <?php } ?>
                          </div>
                          <span class="bidme_link_left bidme_link_right bidme_link_left1 bidme_link_right1 fl">&nbsp;</span> </div>
                        <?php endif;?>
                      </td>
                    </tr>
                    <tr>
                      <td align="center" colspan="2"><!--Buy Now Auction-->
                        ...
                        <a href="<?php echo URL_BASE;?>site/buynow/buynow_addcart/<?php echo $product_result['product_id'];?>" title="<?php echo __('buy_now');?>"><img src="<?php echo IMGPATH;?>buynow_2.png"></a>
                        <?php endif;?>
                        <?php //}?>
                        <!--End Buy Now auction-->
                      </td>
                  ...
                  <div class="product_detail_middle_right fl clearfix">
                          ...
                          (function()
        		   {
					...
					?>
                          <a href="http://twitter.com/share?url=<?php echo $url;?>&amp;text=<?php echo $product_result['product_name'];?>" target="_blank"  title="Twitter" class="fl"> <img src="<?php echo IMGPATH;?>twitter_link_icon.png" alt="Twitter" border="0" class="fl"s/> </a> </li>
                        <li class="fl"> <a href="https://www.facebook.com/sharer.php?u=<?php echo $url;?>&t=<?php echo $product_result['product_name'];?>" title="Facebook" class="fl" target="_blank"> <img src="<?php echo IMGPATH;?>fbook_icon.png" alt="Facebook" border="0" class="fl"s/> </a> </li>
                        <li class="fl" >
              ...
              <div class="product_bid_price wit-action fl mt15">
                
               
                  <p><?php echo __('with_each_bid');?></p>
                 	<div class="table_round">
                 	<div class="table_top_round">
                    </div>
                    <div class="table_mid_round">
                  <table cellpadding="0" cellspacing="0" border="0" align="right"  style="width:240px; ">
                    <tr>
                      <th align="center"><?php echo __('price_increases_by_label');?></th>
                    </tr>
                    <tr>
                      <td align="center"><b style="width:200px; color:#BB006F;"><?php echo $site_currency." ".$product_result['bidamount'];?></b></td>
                    </tr>
                    <tr>
                      <th align="center"><?php echo __('retail_price_label')?></th>
                    </tr>
                    <tr>
                      <td align="center"><b  style="width:200px; color:#BB006F;"><?php echo $site_currency." ".Commonfunction::numberformat($product_result['product_cost']);?></b></td>
                    </tr>
                    <tr>
                      <th align="center"><?php echo __('price_paid_user');?> </th>
                    </tr>
                    <tr>
                      <td align="center"><b  style="width:200px; color:#BB006F;"><span class="pricepaid" style="color:#BB006F; font:bold 12px Arial, Helvetica, sans-serif!important;">
                        <?php 
                  ...
                  <div class="table_bottom_round"></div>
                </div>
              ...
              <div class="product_price_detail fl mt15">
                ...
                <div class="save-middle save_over clearfix">
                  <div class="price_detail_cnt fl clr">
                    ...
                    <b class="fl clr mt10"><?php echo __('from_the_normal_retail_price_label');?> </b > </div>
                </div>
                <!--<div class="save-bl">
                  <div class="save-br">
                    <div class="save-bm"> </div>
                  </div>
                </div>-->
              </div>
            </div>
      ...
      <div class="product_sidebar fr">
        ...
        <div class="product_sidebar1 fl clr">
          <div class="product_sidebar_tab fl">
            <ul class="clearfix">
              <li class="fl active"> <span class="fl product_sidebar_tab_left">&nbsp;</span> <span class="fl product_sidebar_tab_middle pl5 pr5"><?php echo __('bid_history_label');?></span> <span class="fl product_sidebar_tab_left product_sidebar_tab_right">&nbsp;</span> </li>
              <!-- <li class="fl" style="margin:0 0 0 2px;">
                        	<a href="#" title="Bid History" class="fl">
                            	<span class="fl product_sidebar_tab_left">&nbsp;</span>
                                <span class="fl product_sidebar_tab_middle pl5 pr5"><?php echo __('bidding_buttler');?></span>
          ...
          <div class="bid-block clearfix fl">
            ...
            <div class="product-middle1 clearfix">
              <table cellpadding="0" cellspacing="0" border="0" width="284" class="bidding-table">
                <tr>
                  <th width="100" style="width:65px; word-wrap:break-word !important;display:block; float:left;"  align="center"><?php echo __('Price_label');?></th>
                  <th width="100"  style="width:65px; word-wrap:break-word !important;display:block; float:left;" align="center"><?php echo __('Bidder_label');?></th>
                  <th width="100" style="width:73px; word-wrap:break-word !important;display:block; float:left;"  align="center" style="width:60px;"><?php echo __('Date_label');?></th>
                  <th width="82" style="width:54px; word-wrap:break-word !important;display:block; float:left;"  align="center"><?php echo __('Bid_typelabel');?></th>
                </tr>
              </table>
              <!--Bid history-->
    ...
    <div class="product_container product_container1 fl clr mt20 pt10">
      <div class="product_btm_content_left fl">
        ...
        <table align="left" cellpadding="0" cellspacing="0" border="0" width="288">
          <tr>
            <th align="left" style="border-bottom:1px solid #C2C2C2"><?php echo __('auction_id_label');?>: </th>
            <td align="right" style="border-bottom:1px solid #C2C2C2"><p><?php echo $product_result['product_id'];?></p></td>
          </tr>
          <tr>
            <th align="left" style="border-top:1px solid #FFF;"><?php echo __('Auction_type_label');?> : </th>
            <td align="right" style="border-top:1px solid #FFF;"><span><?php echo Ucfirst($product_result['typename']);?></span></td>
          </tr>
        </table>
      ...
      <div class="product_btm_content_middle fl">
        ...
        <table align="right" cellpadding="0" cellspacing="0" border="0" width="288">
          <tr>
            <th align="left" style="border-bottom:1px solid #C2C2C2"><?php echo __('price_starts_from');?>: </th>
            <td align="right" style="border-bottom:1px solid #C2C2C2"b><span><?php echo $site_currency." ".Commonfunction::numberformat($product_result['starting_current_price']);?></span></td>
          </tr>
          <tr>
            <th align="left" style="border-top:1px solid #FFF; border-bottom:1px solid #C2C2C2"><?php echo __('start_time_label');?>: </th>
            <td align="right" style="border-top:1px solid #FFF; border-bottom:1px solid #C2C2C2"><span><?php echo Commonfunction::date_to_string($product_result['startdate']);?></span></td>
          </tr>
          <tr>
            <th align="left" style="border-top:1px solid #FFF;"><?php echo __('end_time_label');?>: </th>
            <td align="right" style="border-top:1px solid #FFF;"><span><?php echo Commonfunction::date_to_string($product_result['enddate']);?></span></td>
          </tr>
        </table>
        <div class="border_bottom_tab"></div>
      </div>
      <div class="shipping_detail fl">
        ...
        <div class="shopping-block clearfix">
          <div class="shipping_title btno fl clr">
            <p class="fl"><?php echo __('Shipping_fee_label');?> :</p>
            <span class="fr"><?php echo  $site_currency." ".$product_result['shipping_fee'];?></span> </div>
          <div class="shipping_title fl bbno clr">
            <p class="fl"><?php echo __('Shipping_information_label');?> :</p>
            <span class="fr"><?php echo $product_result['shipping_info'];?></span> </div>
        </div>
        <div class="border_bottom_tab"></div>
      </div>
    </div>
