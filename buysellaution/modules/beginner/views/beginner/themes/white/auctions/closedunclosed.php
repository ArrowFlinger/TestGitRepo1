...
if($product_result['in_auction']==2){?>
		...
		<div class="auction_rgt">
				<label><a href="<?php echo URL_BASE;?>auctions/view/<?php echo $product_result['product_url'];?>" title="<?php echo 	ucfirst($product_result['product_name']);?>" ><?php echo strlen($product_result['product_name'])>20?substr(ucfirst($product_result['product_name']),0,15)."...":ucfirst($product_result['product_name']);?>
				</a></label>
				<ul>
			...
			<?php }?>
              ...
              <div class="bidme_link">
                ...
                <div class="bidnow_mid">
                 ...
                 <p>  <a href="javascript:;" id="<?php echo $product_result['product_id']; ?>" name="<?php echo URL_BASE; ?>auctions/bid/" class="bid" title="<?php echo ($auction_userid == '') ? __('logins_label') : __('bid_now_label'); ?>" rel="<?php echo URL_BASE; ?>users/login/"  data-auctiontype ="<?php echo $product_result['auction_type']; ?>">
