         ...
         <div class="feature_box">
          <div class="feature_lable"></div>
            ...
            <div class="feature_rgt">
             ...
             <p class="countdown"><img src="<?php echo IMGPATH.'ajax-loader.gif';?>"/></p>
            </div>
			...
			<?php }?>
              ...
              <div class="bidme_link">
                ...
                <div class="bidnow_mid">
                  <p>  <a href="javascript:;" name="<?php echo URL_BASE; ?>auctions/bid/<?php echo $product_result['product_id']; ?>" class="bid" title="<?php echo ($auction_userid == '') ? __('logins_label') : __('bid_now_label'); ?>" rel="<?php echo URL_BASE; ?>users/login/" id="<?php echo $product_result['product_id']; ?>" data-auctiontype ="<?php echo $product_result['auction_type']; ?>">
