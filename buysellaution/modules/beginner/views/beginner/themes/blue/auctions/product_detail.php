...
<!--Map End-->
	<?php  
    			if(($product_result['product_image'])!="" && file_exists(DOCROOT.PRODUCTS_IMGPATH_THUMB2.$product_result['product_image']))
					...
					$small_size_img=URL_BASE.PRODUCTS_IMGPATH_THUMB6.$product_result['product_image'];
					 
				}
				else
				{  
					$product_full_size=IMGPATH.NO_IMAGE;
					$small_size_img=IMGPATH.NO_IMAGE;
...
<div class="container-block">
    ...
    <div class="product_container clr mt15 auction_item" id="auction_<?php echo $id;?>" name="<?php echo URL_BASE;?>auctions/process">
     ...
     <div id="welcomeHero">
		<div id="slideshow-main">
			<ul>
				<li class="p1 active">
					<a class="fl lightbox" title="<?php echo ucfirst($product_result['product_name']);?>"> <img src="<?php echo $product_full_size;?>" width="370" height="284" border="0" class="fl" /><?php if($product_result['product_process']=="C" && $product_result['lastbidder_userid']!=0){?><img src="<?php echo IMGPATH.PRODUCTSOLD_IMAGE;?>"class="sold_image"/><?php } ?></a>
				</li>
		...
		<div id="slideshow-carousel">				
			  <ul id="carousel" class="jcarousel jcarousel-skin-tango">
				<li><a href="#" rel="p1"><img src="<?php echo $small_size_img;?>" width="73" height="64" alt="#" /></a></li>
    ...
    <div class="product_detail_top_right clearfix">
			 ...
			 <div class="buy_now_l"></div>
				...
				<a href="<?php echo URL_BASE;?>site/buynow/buynow_addcart/<?php echo $product_result['product_id'];?>" title="<?php echo __('buynow_label');?>"><?php echo __('buynow_label');?></a>		
                            </div>
                               ...
                               <tr><td align="center"><p style="width:200px;color:#e37c00;"><?php echo $site_currency." ".$product_result['bidamount'];?></p></td>
                            	...
                            	<tr>
                                	<th align="center"><?php echo __('retail_price_label')?></th>
                                      </tr>   <tr> <td align="center"><p  style="width:200px;color:#e37c00;"><?php echo $site_currency." ".$product_result['product_cost'];?></p></td>
                                </tr>
                                <tr>
                                	<th align="center"><?php echo __('price_paid_user');?> </th>
                                       </tr>   <tr><td align="center"><p  style="width:200px;color:#e37c003;"><span class="pricepaid" style="color:#e37c00;"> <?php 
