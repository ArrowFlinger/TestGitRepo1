...
$id="";foreach($productsresult as $product_result):
...
<?php endif;?>
				...
				<div  class="proding"><a href="<?php echo URL_BASE;?>site/buynow/addtocart_list/<?php echo $product_result['product_id'];?>" title="<?php echo __('buy_now');?>"><img src="<?php echo IMGPATH;?>buynow_3.png"></a>	</div>
                    	...
                    	<div class="product_bid_price fl mt15">                        	
                            <table cellpadding="0" cellspacing="0" border="0" align="right" class="mt10 mr10">
                            	...
                            	<tr>
                                    ...
                                    <td align="left"><?php echo $site_currency." ".$product_result['product_cost'];?></td>
                                </tr>
                                <tr>
