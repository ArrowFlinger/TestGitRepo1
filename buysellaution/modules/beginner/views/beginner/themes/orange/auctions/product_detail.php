...
<div class="moving_tt">
				<a href="<?php echo URL_BASE;?>site/buynow/buynow_addcart/<?php echo $product_result['product_id'];?>" title="<?php echo __('buy_now');?>"><img src="<?php echo IMGPATH;?>buynow_3.png"></a>	</div>	
