...
<div class="countdown_future fl clr" style="text-align:center;width:100%;font-weight:bold;background-color:#F4F4F4;"><?php echo __('comingsoon_text'); ?></div>
            ...
            <div class="countdown countdown_future fl clr"><img src="<?php echo IMGPATH . 'ajax-loader.gif' ?>"/><p class="fl clr"><?php echo __("time_countdown_label") . " : " . $product_result['bidding_countdown']; ?> <?php echo __('secs');?></p></div>
