...
<div class="pop_top_bg">
 ...
 <div class="auction_share_icon fl clr mt5" style="height:65px;" >
		   ...
		   <a><fb:like  style="float:left;width:auto;" href="<?php echo $url = URL_BASE.'auctions/view/'.$product_result['product_url'];?>" layout="button_count" width="84" send="false" ref="" style="border:none;"  ></fb:like><?php //echo $include_facebook;?>	<!--End of facebook-->	 </a>
        </div> 
           </div>
        <!--End of share-->
        <div class="watch_list fl clr">
