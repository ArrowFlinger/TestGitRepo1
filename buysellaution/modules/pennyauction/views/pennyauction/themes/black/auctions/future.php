...
<div class="auction_type" data-auctiontype="<?php echo $product_result['auction_type'];?>"></div>
  ...
  <div class="action_item_img fl"> <a href="<?php echo URL_BASE;?>auctions/view/<?php echo $product_result['product_url'];?>" class="fl" title="<?php echo $product_result['product_name'];?>">
    ...
    <div class="action_item_detail fl clr">
      ...
      <p class="fl clr mt5"><span class="fl"><?php echo __("time_countdown_label")." :"?></span> <span style="float:left"><?php echo $product_result['bidding_countdown'];?> <?php echo __('secs');?></span> </p>
    </div>
  </div>
