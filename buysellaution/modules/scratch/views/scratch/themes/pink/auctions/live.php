...
<div class="pop_top_bg">
			 ...
			 <span class="scratch_icon"></span>
                	...
                	<p class="fl clr mt5"><span class="fl"><?php echo __("time_countdown_label")." :"?></span> <span style="float:left"><?php echo $product_result['bidding_countdown'];?> <?php echo __('second_label');?></span>
</p>
                </div>
                </div>
