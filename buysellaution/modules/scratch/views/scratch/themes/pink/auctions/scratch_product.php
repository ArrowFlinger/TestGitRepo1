...
<div class="action_content_left fl">
        ...
        <!--List products-->
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  class="table-top watch-table">
                    <thead>
                ...
                <tr>
                        ...
                        ?>
                        <img src="<?php echo $product_img_path;?>" width="50" height="50"  class="fl" title="<?php echo ucfirst($product_result['product_name']);?>" />
                        </td>
                        <td width="100" align="center"><a href="<?php echo url::base();?>auctions/view/<?php echo $product_result['product_url'];?>" title="<?php echo ucfirst($product_result['product_name']);?>"><p><?php echo ucfirst($product_result['product_name']);?></p></a></td>
