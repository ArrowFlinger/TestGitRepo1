...
<div id="auction_<?php echo $product_result['product_id'];?>" class="auction_item auction_item_content" id="scratch_live_page" name="<?php echo URL_BASE;?>auctions/process" data-id="<?php echo $product_result['product_id'];?>">
    <div class="auction_type" data-auctiontype="<?php echo $product_result['auction_type'];?>"></div>
         ...
         <div class="feature_lable"></div>
			...
			<?php }?>
              ...
              <div class="feature_bott_rgt" id="scratch_feature_rgt" style="margin-right:5px!important;">
              <div class="bidme_link">
                <div class="bidnow_lft"></div>
                <div class="bidnow_mid">
                
                 <p>  <a href="<?php echo URL_BASE; ?>auctions/view/<?php echo $product_result['product_url']; ?>"   title="<?php echo __('scratch_label'); ?>"> <?php echo __("scratch_label"); ?>
                                    </a></p>
