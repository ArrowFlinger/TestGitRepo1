	...
	{?>
		<div class="feature_left_box"> <div class="auction_lft">			  
            ...
            <div class="feature_bott_lft">
				...
				<a title="<?php echo __('add_to_watchlist');?>" rel="<?php echo $product_result['product_id'];?>" class="addwatchlist" name="<?php echo URL_BASE;?>auctions/addwatchlist"><img src="<?php echo IMGPATH;?>plus_bg.png" width="24" height="25" alt="Plus" /></a>
            </div>
         ...
         <div class="feature_lable"></div>
          ...
          <?php if($status==3){?> <div class="futureday mt10"></div><?php } ?>
            <div class="feature_bott">
              <div class="feature_bott_lft">
				<div class="sliders">
                                        <a><img src="<?php echo URL_BASE.'public/'.THEME.'/auction/scratch/images/';?>scratch_icon.png" width="18" height="18" alt="Scratch Auction" title="<?php echo __('Scratch Auction'); ?>" /></a>
              			 
					<?php if($product_result['auction_type']=="25"){?>
					<a><img src="<?php echo IMGPATH;?>head_top1_bg.png" width="18" height="18" alt="<?php echo __('beginner_label'); ?>" title="<?php echo __('beginner_label'); ?>" /></a>
					<?php }?>
					
					<?php if($product_result['auction_type']=="30"){?>
					...
					<?php if($product_result['auction_type']=="26"){?>
					<a><img src="<?php echo IMGPATH;?>head_top3_bg.png" width="18" height="18" alt="<?php echo __('peak_label'); ?>"  title="<?php echo __('peak_label'); ?>"  /></a>
					<?php }?>
              ...
              <a title="<?php echo __('add_to_watchlist'); ?>"><img src="<?php echo IMGPATH;?>plus_bg.png" width="24" height="25" alt="<?php echo __('add_to_watchlist'); ?>" /></a>
             </div>
             ...
             <div class="bidme_link">
				<div class="bidnow_lft"></div>
					<div class="bidnow_mid">                
						 <p>
							 <a href="javascript:;" id="<?php echo $product_result['product_id']; ?>" name="<?php echo URL_BASE; ?>auctions/bid/" class="bid" title="<?php echo ($auction_userid == '') ? __('logins_label') : __('bid_now_label'); ?>" rel="<?php echo URL_BASE; ?>users/login/"  data-auctiontype ="<?php echo $product_result['auction_type']; ?>">
