        ...
        <div class="scratch_mid">
         ...
         <!--scratch detail 2 ends -->
            ...
            <div class="buynowok">
                ...
                <span class="scratch_cancel_left">&nbsp;</span>
                 <span class="scratch_cancel_mid"><a href="#close-example1" id="close-example1" title="<?php echo __('cancel_label');?>"><?php echo __('cancel_label');?></a></span>
                 <span class="scratch_cancel_right">&nbsp;</span>
            </div>
    ...
    <div class="whit_mid">
        	<table align="left" cellpadding="0" cellspacing="0" border="0" width="298">
            	<tr>
                	...
                	<td align="right"><p style="text-align:right;"><?php echo $product_result['product_id'];?></p></td>
            	</tr>
                <tr>
