<?php foreach ($productsresult as $product_result): ?>
        ...
        <div class="deal-mid clearfix">
            ...
            <div class="image-block fl">
                ...
                <div class="action_item_img"> 
                    ...
                    <p><?php echo __("time_to_label") . "  " . $product_result['timetobuy']; ?><?php echo  __('second_label');?></p>
                </div>
                </div>
            </div>
    ...
    <div class="scratch_home">
        ...
        <div class="scratch_price clearfix" style="margin-top:15px;" >
                <span class="scratch_price_left">&nbsp;</span>
                 ...
                 <span class="scratch_price_right">&nbsp;</span>
				  ...
				  <div class="action_price" style="float:left;width:90%;text-align:center;margin-top:15px;" >
