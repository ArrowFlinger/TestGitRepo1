...
abstract class Captcha
{
	...
	public static function valid($response)
	{
		...
		$result = ((sha1(strtoupper($response)) === Session::instance()->get('captcha_response')))?1:0;
		//print_r(Session::instance()->get('captcha_response'));echo "==";print_r(sha1(strtoupper($response)));exit;
