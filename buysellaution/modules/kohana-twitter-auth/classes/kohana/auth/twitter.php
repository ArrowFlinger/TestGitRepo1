...
class Kohana_Auth_Twitter extends Auth {
	...
	public function ttweet($statusMessage="")
	{
		$tweet=$this->twitterObj->post_statusesUpdate(array('status' => $statusMessage));
		return (bool) $tweet;	
	 ...
	 * @return  string
	 */
	public function get_auth_link($url="")
	{
		return $this->twitterObj->getAuthorizeUrl(null,array('oauth_callback'=>$url));
	}
