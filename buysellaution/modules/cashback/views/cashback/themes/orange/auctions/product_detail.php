...
<div class="container-block">
    ...
    <div class="product_detail_top_right clearfix">
                <div class="price-container fl">
                        ...
                        <ul class="timer-list">
                        <li class="not"><p class="fl" style="font-size:14px; font-weight:bold;color:#2891c2;"><?php echo __('price_label');?> :</p><p class="fl"  style="font-size:14px; font-weight:bold;"><span class="currentprice" style="color:#2891c2;"><?php echo ($product_result['product_process']==CLOSED)? $site_currency." ".$product_result['current_price']:$product_result['current_price'];?></span><span class="price" style="display:none;"></span></p></li>
                       
                        <li> <p class="fl" style="font-size:14px; font-weight:bold;"><?php echo __('highest_bidder_label');?>:</p><p class="fl" style="font-size:14px; font-weight:bold;"><b><strong class="lastbidder"><?php echo ($product_result['lastbidder_userid']==0)?__('no_bids_yet'):ucfirst($product_result['username']);?></strong></b></p> </li>
				...
				<a class="moving_tt" href="<?php echo URL_BASE;?>site/buynow/buynow_addcart/<?php echo $product_result['product_id'];?>" title="<?php echo __('Buy Now');?>"><img src="<?php echo IMGPATH;?>buynow_3.png"></a>		
                               ...
                               <tr><td align="center"><p style="width:200px;color:#2891c2;" class="bidamount"><?php echo $site_currency." ".$product_result['bidamount'];?></p></td>
                            	...
                            	<tr>
                                	<th align="center"><?php echo __('retail_price_label')?></th>
                                      </tr>   <tr> <td align="center"><p  style="width:200px;color:#2891c2;"><?php echo $site_currency." ".$product_result['product_cost'];?></p></td>
                                </tr>
                                <tr>
    ...
    <div class="whit_mid">
        	<table align="left" cellpadding="0" cellspacing="0" border="0" width="298">
            	<tr>
                	...
                	<td align="right"><p style="float: right;"><?php echo $product_result['product_id'];?></p></td>
            	</tr>
                <tr>
