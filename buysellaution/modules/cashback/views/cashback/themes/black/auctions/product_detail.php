				...
				<?php if($product_result['product_process']!=CLOSED){?>
                        	<div class="add_watch_list fl pl5">
                                ...
                                <span class="soon_middle fl pl5 pr5">
                                    <a href="javascript:;" class="future fl addwatchlist" title="Add to watchlist" rel="<?php echo $product_result['product_id'];?>"  name="<?php echo URL_BASE;?>auctions/addwatchlist"><?php echo __('add_to_watchlist');?></a>
                                </span>
