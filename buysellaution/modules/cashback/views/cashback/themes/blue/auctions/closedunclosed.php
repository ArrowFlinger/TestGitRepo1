...
<div class="auction_item_content cashback_product_container" name="<?php echo URL_BASE;?>auctions/process">
        ...
        <span class="penny"></span>
		  ...
		  <div class="action_bidder_name fl clr">
            ...
            <span class="read_more" ><a style="margin-top:10px;" href="<?php echo URL_BASE; ?>auctions/view/<?php echo $product_result['product_url']; ?>">More Info</a></span>
...
<?php } else {?>
    ...
    <div id="auction_<?php echo $product_result['product_id']; ?>" class="auction_item auction_item_content cashback_product_container" name="<?php echo URL_BASE; ?>auctions/process" data-id="<?php echo $product_result['product_id']; ?>">
