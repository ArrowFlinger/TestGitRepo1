    ...
    <div class="footer_content">
        ...
        <h6><?php echo __('menu_registration');?></h6>
                <ul class="footer-list">
                        <li><a title=" <?php echo __('menu_register');?>" targer="_self" title="<?php echo __('menu_register');?>" href="<?php echo URL_BASE;?>users/signup"><?php echo __('menu_register');?></a> </li>
        ...
        <div class="footer-section2">
                ...
                <ul class="footer-list">
                        ...
                        <li class="fl clr"><a href="<?php echo URL_BASE;?>users/watchlist" title="<?php echo __('my_listings');?>" id="my_watchlist_active"><?php echo __('my_listings');?></a></li>
