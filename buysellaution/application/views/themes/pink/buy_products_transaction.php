...
<div class="action_content_left fl">
        ...
        <tr>
                <td align="left" width="100" class="<?php echo $bg_none;?>"><p class="fl"><?php echo $transaction['transaction_date'];?></p></td>
                ...
                <td align="center" class="<?php echo $bg_none;?>"><p class="fl"><?php echo $transaction['description']!=""?ucfirst($transaction['description']):"--";?></p></td>
                ...
                <td align="center" width="100" class="<?php echo $bg_none;?>"><b style="color:#3d3d3d; font-weight:normal; padding:0 0 0 22px; width:51px;"><?php if($transaction['amount_type'] == CREDIT){echo $site_currency." ".Commonfunction::numberformat($transaction['amount']);}else{echo "--";} ?></b></td>
                <td align="center" width="20" class="<?php echo $bg_none;?>"><p class="watch_list_time fl"> <?php if($transaction['amount_type'] == DEBIT){echo $site_currency." ".Commonfunction::numberformat($transaction['amount']);}else{echo "--";} ?></p>
                </td>
