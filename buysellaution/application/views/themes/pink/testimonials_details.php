...
<div class="container_inner fl clr">
        ...
        <div class="title-mid">
                <h2 class="fl clr pl10" title="<?php echo __('testimonials');?>"><?php echo __('testimonials');?></h2>
        </div>
        </div>
        </div>
    <div class="deal_list  clearfix" id="testimonials_details_page">
	<div id="managetable" class="testimonial_list fl clr ml20">
        ...
        if($user_results)
        {
                ...
                else
                {
                        ...
                        <div class="thumb_video_list fl" style="*margin-left:-30px;"></div></a>
                ...
                <div class="testimonial_content fl">
                <label class="fr user_name mr10 mt20">
                <?php  //echo $testimonials_result['country'];
