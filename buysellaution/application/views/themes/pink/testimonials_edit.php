		...
		<!--Testimonials Title-->
                ...
                <div class="row_colm1 fl clr mt20">
                        ...
                        <div class="colm2_width fl">
                                ...
                                <?php echo Form::textarea('description',isset($mytestimonials_values['description'])?$mytestimonials_values['description']:$mytestimonials_values[0]['description'],array( 'onkeyup'=>"return limitlength(this, 500)", 'maxlength'=>'500','class'=>'textarea','cols'=>'28', 'rows' => '8'));?>
                                </div>
			...
			?>
			        ...
			        <?php  echo $delete_link; ?>
                                <img src="<?php echo $testimonials_img_path;?>" width="150" height="150" title="" />
                                </div> 
                ...
                <div  style="margin:16px 0 0 261px; color:#333; float:left;">
                <?php  echo __('Or');?>
                </div>
		...
		<?php $content_video_exist=(!empty($mytestimonials_values[0]['video_url']))?YOUTUBE_VIDEO_URL:''; ?>
        	<div class="row_colm1 fl clr mt20">
		        <div class="colm1_width fl"><p><?php echo __('video_label');?>:</p></div>
                   	<div class="colm2_width fl">
                        <div class="inputbox_out fl" style="height:auto;">
