        ...
        <!--List products-->
                ...
                <table width="660" border="0" align="left" cellpadding="0" cellspacing="0"  class="table-top">
                    ...
                    <tr>
                                ...
                                <!--<th width="80" align="center" style="padding:0 0 0  0px;"><b><?php echo __('price');?></b></th>-->
                ...
                <tr>
                        ...
                        <a href="<?php echo url::base();?>auctions/view/<?php echo $watch_result['product_url'];?>">
                        ...
                        ?>
                        <img src="<?php echo $product_img_path;?>" width="50" height="50"   title="<?php echo ucfirst($watch_result['product_name']);?>" />
                        </a>
                        </td>
                        <td width="150" align="center"><p class="watch_list_title  " ><?php echo ucfirst($watch_result['product_name']);?></p></td>
                        <td width="150" align="center" ><p class="watch_list_time"><?php echo $watch_result['enddate'];?></p></td>
                        <!--<td align="center" width="80" ><b  style="color:#3d3d3d; font-weight:normal;"><?php echo  $site_currency." ".Commonfunction::numberformat($watch_result['current_price']);?></b></td>-->
                       
                        <td width="150" align="center">
                        <a href="<?php echo url::base();?>users/watchlist/<?php echo $watch_result['watch_id'];?>"  onclick=" return confirmDelete('<?php echo __('are_you_sure_delete');?>');" title="<?php echo __('button_delete');?>" class="remove_link"></a>
                        </td>
                </tr>
                <?php endforeach; 
                }
