...
<div class="fl edit_content">
	...
	<!--subject dropdown-->
        ...
        <div class="row_colm1 fl clr mt20">
                ...
                <span class="info_label" style="display:block"><?php echo __('ex_telephone_label');?></span>
                </label>    
                </div>
        </div>
        ...
        <div class="row_colm1 fl clr  mt20">
                ...
                <div class="colm2_width fl">
                        ...
                        <input name="submit_user" type="submit" value="<?php echo __('button_reset');?>" class="fl"/>
                        </span>
