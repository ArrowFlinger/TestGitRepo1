...
<div class="signup_form_left fl">
	<?php echo Form::open(NULL,array('method'=>'post','enctype' => 'multipart/form-data'));?>
        ...
        <div class="row_colm1 fl clr">
                ...
                <label class="signup_errore_msg fl"><span class="red"><?php if($errors){echo (array_key_exists('username',$errors))? $errors['username']:"";}?></span></label>
                </div>
        </div>
        <!--email-->
        <div class="row_colm1 fl clr mt20">
                ...
                <label class="signup_errore_msg fl"><span class="red"><?php if($errors){echo (array_key_exists('email',$errors))? $errors['email']:"";}?></span></label>
                </div>
        </div>
        <!--password-->
        <div class="row_colm1 fl clr mt20">
                ...
                <label class="signup_errore_msg fl"><span class="red"><?php if($errors){echo (array_key_exists('password',$errors))? $errors['password']:"";}?></span></label>
                </div>
        </div>
        <!--Retype password-->
        <div class="row_colm1 fl clr mt20">
   ...
   <div class="row_colm1 fl clr mt20">
    <div class="colm1_width fl"><p><?php echo __('map_details');?></p></div>
     <div class="colm2_width fl">
        ...
        <div id="showmap" class="row_colm1 ">
		
		<input type="button" value="<?php echo __('search_label');?>" onclick="showAddress()" />
		<div>
			<div align="center" id="map" style="width: 600px; height: 400px; float:left;"><br/></div>
			<br>
