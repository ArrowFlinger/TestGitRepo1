                    ...
                    <li class="fl clr  mt5">
                        ...
                        <div class="blog_reply_content fl mt5">
                            ...
                            <div class="blog_reply_content_right fr">
                                    ...
                                    <span class="fl clr mt5 "><a href="<?php echo $get_blog_comments['website'];?>" class="website_url" title="<?php echo $get_blog_comments['website'];?>"><?php echo $get_blog_comments['website'];?></a></span>
                            </div>
                     	</div>       
                    </li>
                </ul>
                ...
                <tr>
                        ...
                        <div class="row_colm1 fl clr mt20">
                                ...
                                <div class="colm2_width fl">
                                        ...
                                        <?php echo Form::textarea('comment',trim($form_values['comment']),array("id"=>"comment","maxlength"=>"510","onkeyup"=>"return limitlength(this, 510);")) ?>
                                        </div>
