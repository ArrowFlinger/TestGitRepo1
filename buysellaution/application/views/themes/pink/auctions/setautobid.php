	...
	<div class="watch_list_items watch_list_items2 fl clr">	
        ...
        <table width="660" border="0" align="left" cellpadding="0" cellspacing="0"  class="table-top">
                <tr>
                        ...
                        <th width="125" align="center" style="padding:0 0 0 25px;"><b><?php echo __('price');?></b></th>
		...
		<?php //print_r($autobid);?>
                <tr>
                        ...
                        ?></p></td> */ ?>
                        <td align="center" width="18%"><b style="color:#3d3d3d; font-weight:normal;width:100px; word-wrap:break-word;"><?php echo $site_currency." ".Commonfunction::numberformat($autobid['bid_amount']); ?></b></td>
