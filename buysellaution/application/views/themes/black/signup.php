...
document.write('<style type="text/css">input.styled { display: none; } select.styled { position: relative; width: ' + selectWidth + 'px; filter: alpha(opacity=0); z-index: 5; } .disabled { opacity: 0.5; filter: alpha(opacity=50); }</style>');
 ...
 <?php echo Form::input('email',isset($form_values['email'])?$form_values['email']:__('enter_email'),array('maxlength'=>'30','class'=>'textbox','id'=>'email','onfocus'=>'label_onfocus("email","'.__('enter_email').'")','onblur'=>'label_onblur("email","'.__('enter_email').'")'));?>			
        ...
        <div class="row_colm1 fl clr pad_bot10">
         ...
         <div class="row_colm1 fl clr pad_bot10">
             ...
             <div class="colm2_width fl" style="width:390px;">
      <div id="close" style="align:right;"></div> 
			   <div id="close" style="align:right;"><a style="width:25px;float:left;height:20px;" href="#" title="<?php echo __('close_label');?>"> &nbsp;</a> </div><br>  
			...
			<?php echo Form::input('address1',isset($_POST['address1'])?$_POST['address1']:__('search_places'),array('maxlength'=>'40','class'=>'textbox','id'=>'address1','onfocus'=>'label_onfocus("address1","'.__('search_places').'")','onblur'=>'label_onblur("address1","'.__('search_places').'")'));?>
               ...
               <div id="showmap">
               <input style="padding:0px;" type="button" value="<?php echo __('search_label');?>" onclick="showAddress()" />		
		<div>
	...
	if(isset($referrer_name)){?>
	 <div class="row_colm1 fl clr mt15 pad_bot10">
...
<div class="login_form_right fr mt75">
            <div class="signup_link fl clr mt75">
        		<h4 class="fl clr"><?php echo __('already_a_member');?>?</h4>
        		<p class="fl clr"> <?php echo __('please');?> <a href="<?php echo url::base();?>users/login" title="<?php echo __('menu_signin');?>"><?php echo __('menu_signin')."&raquo;";?></a></p>
        	</div>
        </div>
</div>
