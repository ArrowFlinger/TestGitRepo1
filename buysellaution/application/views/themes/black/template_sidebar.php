...
<div class="user" style="display:none;" ><?php echo $auction_userid;?></div>
			<?php  
                	...
                	$check_msg = Message::get();
                        if($check_msg){
                         ?>
							...
							<?php echo $content;?>
							<?php echo new View(THEME_FOLDER."auctions/right");?>
		        		</div>
                   	</div>
               	</div>     	    
				<!--User message--> 
				...
				<!--<div style="width:400px;height:100px;position:fixed;z-index:999;border:1px solid #ccc;padding:15px 10px;background:#FFF;right:0;bottom:0;display:none;" class="user_message">
				<span style="float:right;cursor:pointer;" id="close">X</span>
				<span style="display:none;" id="message_id"><?php echo $user_message[0]['usermessage_id'];?></span>
				<div><strong><?php echo __('new_message');?>:</strong></div>
				<p>
						<a href="<?php URL_BASE;?>/users/my_message_details/<?php echo $user_message[0]['usermessage_id'];?>"><?php echo Text::limit_chars($user_message[0]['usermessage_message'],150);?></a>
					</p>
				</div>--><?php } ?>
