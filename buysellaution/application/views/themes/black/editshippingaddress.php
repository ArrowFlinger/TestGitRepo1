...
<div class="action_content_left fl">
	<div class="title_temp1 fl clr pt10">
    	<h2 class="fl clr pl10" title="<?php echo __('edit_shipping_address');?>"><?php echo __('edit_shipping_address');?></h2>
    </div>
<div class="edit_content fl clr mt20 ml15 pb20">
	...
	<!-- name -->
        <div class="row_colm1 fl clr mt20">
            ...
            <?php 
            if($errors && array_key_exists('name',$errors)){?><label class="errore_msg fl clr"><span class="red"><?php  echo (array_key_exists('name',$errors))? ucfirst($errors['name']):"";?></span></label><?php }
            ?>
            </div>
        </div>
	...
	<!-- Address line1 -->
        <div class="row_colm1 fl clr mt20">
		 ...
		 echo Form::input('address1', isset($form_values['address1'])?$form_values['address1']:$address[0],array("id"=>"address_line1","Maxlength"=>"50",'title'=>__('address_line1'))) ?>
           ...
           <?php if($errors && array_key_exists('address1',$errors)){?> <label class="errore_msg fl clr"><span class="red"><?php  echo (array_key_exists('address1',$errors))? ucfirst($errors['address1']):"";?></span></label><?php }?>
        	</div>
        </div>
...
echo Form::input('address2',isset($form_values['address2'])?$form_values['address2']:$address2,array("id"=>"address_line2","Maxlength"=>"50",'title'=>__('address_line2'),'onfocus'=>'label_onfocus("address_line2","'.__('enter_address2').'")','onblur'=>'label_onblur("address_line2","'.__('enter_address2').'")')) ?>
           ...
           <?php if($errors && array_key_exists('address2',$errors)){?> <label class="errore_msg fl clr"><span class="red"><?php  echo (array_key_exists('address2',$errors))? ucfirst($errors['address2']):"";?></span></label><?php }?>
        	</div>
        </div>
	...
	<!--Country-->
		...
		<?php if($errors && array_key_exists('country',$errors)){?> <label class="errore_msg fl">
                <span class="red"><?php echo (array_key_exists('country',$errors))? ucfirst($errors['country']):"";?></span>
            </label><?php }?>
            </div>
        </div>
	...
	<!-- City-->
        <div class="row_colm1 fl clr mt20">
            ...
            <?php if($errors && array_key_exists('city',$errors)){?><label class="errore_msg fl clr"><span class="red"><?php  echo (array_key_exists('city',$errors))? ucfirst($errors['city']):"";?></span></label><?php }?>
        	</div>
        </div>
	...
	<!-- Town-->
		...
		echo Form::input('town',isset($form_values['town'])?$form_values['town']:$town,array("id"=>"town","Maxlength"=>"50",'title'=>__('town'),'onfocus'=>'label_onfocus("town","'.__('enter_town').'")','onblur'=>'label_onblur("town","'.__('enter_town').'")')) ?>
            ...
            <?php if($errors && array_key_exists('town',$errors)){?><label class="errore_msg fl clr"><span class="red"><?php  echo (array_key_exists('town',$errors))? ucfirst($errors['town']):"";?></span></label><?php }?>
        	</div>
        </div>
	...
	<!-- pincode-->
        <div class="row_colm1 fl clr mt20">
           ...
           <?php if($errors && array_key_exists('zipcode',$errors)){?> <label class="errore_msg fl clr"><span class="red"><?php  echo (array_key_exists('zipcode',$errors))? ucfirst($errors['zipcode']):"";?></span></label><?php }?>
        	</div>
        </div>
	...
	<!-- Phone-->
        ...
        <?php if($errors && array_key_exists('phone',$errors)){?><label class="errore_msg fl clr"><span class="red"><?php  echo (array_key_exists('phone',$errors))? ucfirst($errors['phone']):"";?></span></label><?php }?>
        <br clear="left">
        <div style="color:#999"><?php echo __('ex_telephone_label');?></div>
        </div>
        </div>
        ...
        <div class="row_colm1 fl clr mt20">
            ...
            <span class="login_submit_btn_middle fl"><?php echo Form::submit('editaddress',__('button_update'),array('title'=>__('button_update')));?></span>
