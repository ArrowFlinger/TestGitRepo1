...
<div class="action_content_left fl">
	<div class="title_temp1 fl clr pt10">
    	<h2 class="fl clr pl10" title="<?php echo __('add_shipping_address');?>"><?php echo __('add_shipping_address');?></h2>
    </div>
	...
	<!-- Phone-->
        ...
        <!--Submit button-->
            <div class="row_colm1 fl clr mt20">
                ...
                <span class="login_submit_btn_middle add_address fl"><?php echo Form::submit('addaddress',__('add'),array('title'=>__('add')));?></span>
