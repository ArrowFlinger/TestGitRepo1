<?php defined("SYSPATH") or die("No direct script access."); echo "asfafasfasf"; ?>
        <div class="wrapper_outer" id="process_page">
            <div class="wrapper_inner">
                <div class="wrapper">
                     <div class="auctions_black_authorize_top_bg">
                         ...
                         <div class="auctions_black_authorize_top_mid" style="width:980px;">
			...
			<?php $type=(isset($postvalues['nauction_type']))?$postvalues['nauction_type']:'';?>		     		     
		    <?php		    
		    $k=0;
		    ...
		    foreach($postvalues['id'] as $id){ ?> 
                     ...
                     <div class="actions_black_autorize_mid_bg" style="width:968px;">
			    ...
			    <?php }?>
					...
					foreach($payment_gateway as $key){
						if(isset($key['customfunction']) && $key['customfunction']!="")
						{
							...
							$paythrough=strtolower($key['payment_gatway']);
                    ...
                    <div class="actions_black_autorize_bottom_bg">
                         ...
                         <div class="authorize_border_bg_mid" style="width:978px;"></div>
