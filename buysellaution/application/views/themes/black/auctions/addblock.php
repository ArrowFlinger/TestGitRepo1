...
<?php if($product_result['product_featured']==FEATURED){?><span class="feature_icon"></span><?php } ?>
			 <?php if($product_result['dedicated_auction']==ENABLE){?><span class="bonus_icons"></span><?php } ?>
                ...
                <div class="action_price fl clr"><p class="fl"><span style="display:block;"><?php echo __('price_label');?> :</span> <span class="currentprice"></span><span class="price" style="display:none;"></span></p></div>
                <div class="action_bidder_name fl clr"><span class="high" style="display:block;"><?php echo __('highest_bidder_label');?>:</span> <span class="lastbidder"><?php echo ($product_result['lastbidder_userid']==0)?__('no_bids_yet'):"";?></span>
		<?php 
			...
			?>
	               <!-- <img src="<?php //echo $user_img_path;?>" title="<?php echo $product_result['username'];?>" alt="<?php echo $product_result['username'];?>" class="bidder_photo<?php echo $product_result['product_id'];?>"/>-->
		</div>
                              
                    
            <div class="user" style="display:none;" ><?php echo $user;?></div>
            <div class="bidme_link_out fl clr" style="border:1px soid red;">
                <center>
                <div class="bidme_link width_bidme clr">
                <span class="bidme_link_left fl"> </span>
                <span class="bidme_link_middle fl">
                <a href="javascript:;" name="<?php echo URL_BASE;?>auctions/bid/<?php echo $product_result['product_id'];?>" class="fl bid new_block" title="<?php echo ($auction_userid=='')? __('login_label'):__('bid_me_label');?>" rel="<?php echo URL_BASE;?>users/login/" id="<?php echo $product_result['product_id'];?>">
		...
		<div class="loader<?php echo $product_result['product_id'];?>" style="display:none;"><img src="<?php echo IMGPATH.'ajax-loader.gif';?>"/></div>
            ...
            <div class="bid_price fl clr"><p class="fl clr"><?php echo __("bid_label");?>: <?php echo $site_currency." ".Commonfunction::numberformat($product_result['bidamount']);?></p></div>
