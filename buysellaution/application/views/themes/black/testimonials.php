	...
	<?php echo Form::open(NULL,array('method'=>'post','enctype' => 'multipart/form-data'));?>
        ...
        <div class="row_colm1 fl clr mt20">
            ...
            <div class="inputbox_out fl"><?php echo Form::input('title',$form_values['title'],array('maxlength'=>'30','class'=>'textbox'));?></div>
                ...
                <span class="red"><?php if($errors){echo (array_key_exists('title',$errors))? $errors['title']:"";}?></span>
                </label>
            </div>
            </div>
        </div>    
		...
		<div class="colm1_width fl"><p><?php echo __('description_label');?><span class="red">*</span>:</p></div>
            <div class="colm2_width fl">
                ...
                <?php echo Form::textarea('description',$form_values['description'],array( 'onkeyup'=>"return limitlength(this, 500)", 'maxlength'=>'500','class'=>'textarea','cols'=>'28','style'=>'resize:none;', 'rows' => '8'));?>
                </div>
                <label class="errore_msg fl clr"><span class="red">
					<?php if($errors){echo (array_key_exists('description',$errors))? $errors['description']:"";}?></span>
		...
		<div class="colm1_width fl"><p><?php echo __('image_label');?><span class="red"></span>:</p></div>
               ...
               <input name="photo" type="file"/>
                ...
                <label class="errore_msg fl clr"><span class="red">
                <?php if($errors){echo (array_key_exists('photo',$errors))? $errors['photo']:"";}?></span>
				<span></span>
                </label>
           	</div>
		</div>
		
		<div  style="margin:0 0 0 300px; color:#ccc;">
             	<?php echo __('Or');?>
                </div>
		...
		<div class="colm1_width fl"><p><?php echo __('video_label');?>:</p></div>
               ...
               <?php echo Form::input('video',$form_values['video'],array('class'=>'textbox'));?>
                ...
                <label class="errore_msg fl clr"><span class="red">
					<?php if($errors){echo (array_key_exists('video',$errors))? $errors['video']:"";}?><?php if($video_error){ echo $video_error; } ?></span>
					<br><span style="color:#ccc"><?php echo __('youtube_label');?>  </span>
                </label>
           	</div>
		</div>
