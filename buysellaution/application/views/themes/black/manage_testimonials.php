...
<div class="action_content_left fl">
	...
	<div class="watch_list_items fl clr">
		...
		<th align="center"><b><?php echo __('title');?></b></th>
		<th align="center"><b><?php echo __('description_lable');?></b></th>
		<th align="center"><b><?php echo __('status_lable');?></b></th>
		<th align="center"><b><?php echo __('actions');?></b></th>
		<th align="center"><b><?php echo __('delete_lable');?></b></th>
		...
		<td align="center" width="100" class="<?php echo $bg_none;?>">
            ...
            {  
                    ...
                    <div class="thumb_video_list fl" style="margin:-65px 0 0 25px;*margin:25px 0 0 -70px;"></div></a>
            ...
            <?php
                ...
                <?php echo Text::limit_chars(ucfirst($mytestimonials_results['title']),15);?></p></td>
		
		<td align="center" width="100" class="<?php echo $bg_none;?>"><p class="watch_list_time"><?php echo Text::limit_chars(ucfirst($mytestimonials_results['description']),25);?></p></td>
		<td align="center" width="100" class="<?php echo $bg_none;?>"><p class="watch_list_time">
		<?php echo ($mytestimonials_results['testimonials_status'] == 'A')?__('active_label'):__('inactive_label'); ?></p></td>
		<td align="center"><p class="watch_list_time"><a href="<?php echo URL_BASE;?>users/edit_testimonials/<?php echo $mytestimonials_results['testimonials_id'];?>" title="<?php echo __('Edit');?>" class="delet_link fr"><?php echo __('Edit');?></a></p></td>
		<td align="center">
