...
<div id="managetable" class="fl clr">
	...
	<!--List products-->
        ...
        <table width="660" border="0" align="center" cellpadding="5" cellspacing="0"  class="table-top table-top1">
            <thead>
                <tr>
                        <th align="center" width="120"><b><?php echo __('image');?></b></th>
                        <th  align="center" width="100"><b><?php echo __('title');?></b></th>
                        <th  align="center" width="100"><b><?php echo __('description_lable');?></b></th>
                        <th  align="center" width="100"><b><?php echo __('status_lable');?></b></th>
                        <th align="center" width="100"><b><?php echo __('actions');?></b></th>
                        <th  align="center" width="100"><b class="delete"><?php echo __('delete_lable');?></b></th>		
                </tr>
            </thead>
        <?php 
		...
		<tr>
                        <td align="center" width="120" class="<?php echo $bg_none;?>">
                        ...
                        {  
                                ...
                                {?>
                                <a style="position:relative;" href="javascript:;" onclick="showhide('<?php echo $mytestimonials_results['testimonials_id']; ?>')" >
                                ...
                                <div class="thumb_video_list fl" style="margin:-60px 0 0 25px;*margin:-65p	x 0 0 -25px;"></div></a>
                        ...
                        <td align="center" width="100" class="<?php echo $bg_none;?>"><p class="watch_list_time fl"><?php echo ucfirst($mytestimonials_results['title']);?></p></td>
                        <td align="center" width="100" class="<?php echo $bg_none;?>"><p class="watch_list_time fl"><?php echo Text::limit_chars(ucfirst($mytestimonials_results['description']),25);?></p></td>
                        <td align="center" width="100" class="<?php echo $bg_none;?>"><p class="watch_list_time">
                        <?php echo ($mytestimonials_results['testimonials_status'] == 'A')?'Active':'Inactive'; ?></p></td>
                        <td align="center" style="width:150px;"><p class="watch_list_time"><a href="<?php echo URL_BASE;?>users/edit_testimonials/<?php echo $mytestimonials_results['testimonials_id'];?>" title="<?php echo __('Edit');?>" class="delet_link fr"><?php echo __('Edit');?></a></p></td>
