...
<div class="edit_content fl clr mt20 ml15 pb20" id="user_setting_page">
<?php 
$lat = 48.89364;
$lang = 2.33739;
	...
	<?php echo Form::open(NULL,array('method'=>'post','enctype' => 'multipart/form-data'));?>
    	<div class="row_colm1 fl clr mt20" style="width:600px;">
        ...
        <label class="errore_msg fl clr"><span class="red"><?php if($errors){ echo (array_key_exists('lastname',$errors))? ucfirst($errors['lastname']):"";}?></span></label>
         ...
         <!--Country-->
		  ...
		  <div class="colm1_width fl"><p><?php echo __('map_details');?>:</p></div>
			<div class="inputbox_out fl">
					<input type="text" size="60" maxlength="100" name="address1" id="address1" value="<?php echo isset($data['address1'])?$data['address1']:$user['country']?>"/>
				</div>
		      <div class="colm2_width fl">
		      <?php /*<div id="close" class="user_setting_close_icon" style="align:right;">&nbsp;</div><br>  */?>
		      
               <div id="showmap">
		<div>
        <div class="rupling" style="width:360px;">
			
			<span class="nodus"><input type="button" value="<?php echo __('search_label');?>" onclick="showAddress()"  /></span>
            </div>
		</div>
	...
	<div class="colm1_width fl"><p><?php echo __('photo_label');?> :</p></div>
		...
		<?php
			...
			if(($user['photo']) && (file_exists(DOCROOT.USER_IMGPATH.$user['photo'])))
			  	...
			  	$user_image_path = URL_BASE.USER_IMGPATH.$user['photo'];
			   	...
			   	$delete_link="<a href='javascript:;' onclick='frmdel_photo(".$user['id'].");' class='deleteicon' style='' title='$delete_title' id='photo_delete'></a>"; 
			   	$atag_start='<a href='.$user_image_path.' title='.$image_title.'>'; 
			   	$atag_end='</a>';										   
			}
		 ?> 
         <input name="photo" type="file"/>
         <div class="user_image mt10 fl clr" style="100px;" id="gallery"><?php echo $atag_start;?>                                      
        ...
        <div class="row_colm1 fl clr" style="width:600px;">
		<!-- Submit button -->
        <div class="row_colm1 fl clr  mt20" style="width:600px;">
            ...
            <div class="colm2_width fl">
                ...
                <span class="login_submit_btn_left login_submit_btn_right login_submit_btn_left1 login_submit_btn_right1 fl">&nbsp;</span>
                </div>
