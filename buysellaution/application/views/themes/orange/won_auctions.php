...
<div class="content_left_out content_left_out1 fl" id="won_auctions_page">
		...
		<table width="663" border="0" align="left" cellpadding="0" cellspacing="0" class="table-top">
		        ...
		        <th width="100" align="center"><b><?php echo __('title');?></b></th>
		        	<?php /*<th width="30" align="center"> <b style="width:95px;"> <?php echo __('bidding_type_label');?></b></th> */ ?>
		        <th width="100" align="center"><b><?php echo __('end_time');?></b></th>
		        <th width="100" align="center"><b><?php echo __('price');?></b></th>
		       
		       <?php /* <th width="90" align="center"><b><?php echo __('refund');?></b></th>*/ ?>
		...
		?>
		<tr>
		        <td width="100" align="center" class="<?php echo $bg_none;?>"><a  href="<?php echo url::base();?>auctions/view/<?php echo $won_result['product_url'];?>"><?php 
		        ...
		        <td width="100" align="center" class="<?php echo $bg_none;?>"><p class="won_action_title "><?php echo wordwrap(ucfirst($won_result['product_name']),12,'<br />',1);?></p></td>
		        <td width="100" align="center" class="<?php echo $bg_none;?>"><p class="watch_list_time"><?php echo  $won_result['enddate'];?></p></td>
		        <td width="100" align="center" class="<?php echo $bg_none;?>"><b><?php echo  $site_currency." ".Commonfunction::numberformat($won_result['current_price']);?></b></td>
