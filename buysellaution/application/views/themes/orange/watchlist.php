...
<div class="action_content_left fl">
        ...
        <!--List products-->
                ...
                <table width="660" border="0" align="left" cellpadding="0" cellspacing="0"  class="table-top watch-table">
                    <thead>
                    <tr>
                                <th width="70" align="center"><b><?php echo __('image');?></b></th>
                                <th width="100" align="center"><b><?php echo __('title');?></b></th>
                                <th width="100" align="center"><b class="title"><?php echo __('end_time');?></b></th>
                                <?php /*<th width="90" align="center"><b><?php echo __('price');?></b></th> */?>
                                <th width="100" align="center"><b><?php echo __('actions');?></b></th>
                        </tr>
           </thead>  
                ...
                <tr>
                        ...
                        <td align="center" width="100"><p class="watch_list_title"><?php echo ucfirst($watch_result['product_name']);?></p></td>
                        <td align="center" width="100"  ><p class="watch_list_time"><?php echo $watch_result['enddate'];?></p></td>
                        ...
                        <a href="<?php echo url::base();?>users/watchlist/<?php echo $watch_result['watch_id'];?>" onclick=" return confirmDelete('<?php echo __('are_you_sure_delete');?>');" title="<?php echo __('button_delete');?>" class="delet_link"><?php echo __('button_delete');?></a>
                        </td>
                </tr>
                <?php endforeach; 
                }
