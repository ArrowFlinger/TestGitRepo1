...
<div class="action_content_left fl">
		...
		<table width="660" border="0" align="left" cellpadding="0" cellspacing="0" class="table-top">
                    <thead>
                    <tr>
		                <td width="150" align="center"><?php echo __('friend_image');?></td>
		                <td width="150" align="center"><b><?php echo __('Name');?></b></td>
		                <td width="150" align="center"><b><?php echo __('status_label');?></b></td>
		        </tr>
        ...
        <script type="text/javascript">
	        $.getJSON("https://graph.facebook.com/<?php echo $id;?>",function(data){
                ...
                <tr>
                        ...
                        <td width="150" align="center" class=""><p class="watch_list_title  name<?php echo $i;?>">--</p></td>
                        <td width="150" align="center" class=""><p class="watch_list_title">
                        <?php 
