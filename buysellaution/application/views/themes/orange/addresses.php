...
<div class="action_content_left fl">
        ...
        <div class="deal-left clearfix" id="addresses_page">
<div class="action_deal_list  action_deal_list1 clearfix">
<div class="address_content fl clr mt20 pb20">
    <!-- My addresses-->
    <div class="my_address_out fl clr" style="padding: 0px 10px;">
	...
	<?php $label1=($count_billing==0)?__('add_billing_address'):__('edit_billing_address');?>
		...
		<div id="managetable" class="transaction_list fl clr mt10">
            ...
            <table width="660" border="0" align="left" cellpadding="0" cellspacing="0" class="table-top">
		        ...
		        <tr>
		                ...
		                <th  width="90" align="center"><?php echo __('name_label');?></th>
		                <th width="90" align="center"><b><?php echo __('address');?></b></th>
		                <th width="90" align="center"><b><?php echo __('suburb_town');?></b></th>
		                <th width="90" align="center"><b><?php echo __('city');?></b></th>
		                <th width="90" align="center"><b><?php echo __('postcode');?></b></th>
		                <th width="90" align="center"><b><?php echo __('ph_no');?></b></th>
		                <th width="90" align="center"><b><?php echo __('options');?></b></th>
                ...
                <tr>
                    ...
                    <td width="90" align="center"><p class="watch_list_time"><?php echo ucfirst($shipping_address['name']);?></p></td>
                        
						
			
                       <td width="90" align="center"><p class="watch_list_time"><?php $address= explode("+",$shipping_address['address']);

						                        $address2=(array_key_exists(1,$address))?", ".$address[1]:"";
						                        echo ucfirst($address[0].$address2);?></p></td>

                        <td width="90" align="center"><p class="watch_list_time"><?php echo ($shipping_address['town']=="")?__('-'):ucfirst($shipping_address['town']); ?></p></td>
                        <td width="90" align="center"><p class="watch_list_time"><?php echo ucfirst($shipping_address['city']);?></p></td>
                        <td width="90" align="center"><p class="watch_list_time"><?php echo $shipping_address['zipcode'];?></p></td>
                        <td width="90" align="center"><p class="watch_list_time"><?php echo ($shipping_address['phoneno']=="")?__('-'):$shipping_address['phoneno']; ?></p></td>
                        <td width="90" align="center"><p class="watch_list_time"><a href="<?php echo url::base();?>users/myaddresses/billing/edit" title="<?php echo __('Edit');?>" class="delet_link"><?php echo __('Edit');?></a></p></td>
		...
		<tr>
         <td width="90" align="center"><p class="watch_list_time"><?php echo ucfirst($billing_address['name']);?></p></td>
         <td width="90" align="center"><p class="watch_list_time"><?php $address= explode("+",$billing_address['address']);
					                                $address2=(array_key_exists(1,$address))?", ".$address[1]:"";
					                                echo ucfirst($address[0].$address2);?></p></td>
        <td width="90" align="center"><p class="watch_list_time"><?php echo ($billing_address['town']=="")?__('-'):ucfirst($billing_address['town']); ?></p></td>
        <td width="90" align="center"><p class="watch_list_time"><?php echo ucfirst($billing_address['city']);?></p></td>
        <td width="90" align="center"><p class="watch_list_time"><?php echo $billing_address['zipcode'];?></p></td>
        <td width="90" align="center"><p class="watch_list_time"><?php echo ($billing_address['phoneno']=="")?__('-'):$billing_address['phoneno']; ?></p></td>
        <td width="90" align="center"><p class="watch_list_time"><a href="<?php echo url::base();?>users/myaddresses/billing/edit" title="<?php echo __('Edit');?>" class="delet_link"><?php echo __('Edit');?></a></p></td>
		</tr>
