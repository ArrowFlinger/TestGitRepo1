...
<!-- User Panel STRAT-->
<div class="sidebar_content sidebar_content1 fr">
    	...
    	<div class="sidebar_title sidebar_title1 fl clr"><h4 class="fl clr" title="<?php echo __('menu_user_panel');?>"><?php echo __('menu_user_panel');?></h4></div>
        	...
        	<div class="user_panel_list fl clr">
					<ul class="fl clr">
						...
						<li class="fl clr" ><a href="<?php echo URL_BASE;?>auctions/setautobid" title="<?php echo __('auto_bid_lable');?>"  id="product_autobid_active"><?php echo __('auto_bid_lable');?></a></li>
						<!--<li class="fl clr " ><a href="<?php echo URL_BASE;?>auctions/manage_setautobid" title="<?php echo __('auto_bid_lable');?>" class="fl"  id="autobid_active"><?php echo __('manage_auto_bid_lable');?></a></li>-->
						...
						<li class="fl clr" ><a href="<?php echo URL_BASE;?>users/friends_invite" title="<?php echo __('invite');?>"  id="my_pending_active"><?php echo __('invite');?></a></li>
