...
<?php if($count_live_result>0):?>
        <?php  foreach($result as $product_result):?>
            ...
            <div class="bidme_link_out fl clr">
                ...
                <a href="javascript:;" name="<?php echo URL_BASE;?>auctions/bid" class="bid new_block" title="<?php echo ($auction_userid=='')? __('login_label'):__('bid_me_label');?>" rel="<?php echo URL_BASE;?>users/login/" id="<?php echo $product_result['product_id'];?>">
