<table cellpadding="0" cellspacing="0" border="0" width="420" class="table-bid-history">
 ...
 <td style="width:100px; word-wrap:break-word;border-bottom: 1px solid #e2e1e1;color: #868686;font-weight: bold;list-style: none outside none;padding: 10px 0;text-align: center;"> <?php echo ($bid_history['bid_type']=='AB')?'Auto Bid':'Single Bid';?></td>		
  </tr>
  <?php endforeach;?>
  <?php }  else { ?>
