...
<div class="action_content_left fl">
     ...
     <div class="auto_bid" style=" padding-left:7px;">
	 <!--set to bid--->
...
?>
	...
	<div class="row_colm1 fl clr mt20">
		...
		<div id="autoerror1"></div>
                <span style="float:left;clear:both;width:100%;"><?php echo __('autobid_lable');?> </span>
...
<?php  $count=count($select_autobid);
			if($count>0):?>	
	<div class="watch_list_items watch_list_items2 fl clr" style="padding-left:0px;">	
		...
		foreach($select_autobid as $autobid): ?>
                ...
                <tr>
                        ...
                        <a href="<?php echo URL_BASE;?>auctions/view/<?php echo $autobid['product_url'];?>">
                        ...
                        ?>
                        <img src="<?php echo $product_img_path;?>" width="50" height="50"  title="<?php echo ucfirst($autobid['product_name']);?>"/>
                        </a>
                        </td>
                        <td  width="100" align="center"><p><?php echo ucfirst($autobid['product_name']);?></p></td>		
                        <td  width="100" align="center"><p><?php echo $autobid['enddate'];?></p></td>
                        <?php /*<td align="center" width="20%"><p class="watch_list_time" style="width:68px;"><?php echo $site_currency." ". $autobid['product_cost'];
                        ?></p></td> */ ?>
                        <td  width="100" align="center"><b><?php echo $site_currency." ".Commonfunction::numberformat($autobid['bid_amount']); ?></b></td>
                        <td  width="30" align="center">
                        <a href="<?php echo URL_BASE;?>auctions/view/<?php echo $autobid['product_url'];?>" title="<?php echo __('view_label');?>" class="view_link "><?php echo __('view_label');?></a>
                        </td>
			<td  width="30" align="center">
			<?php if($autobid['product_process']!="C") { ?>
                        <a href="<?php echo URL_BASE;?>auctions/edit_setautobid/<?php echo $autobid['product_id'];?>" title="<?php echo __('edit_label');?>" class="view_link "><?php echo __('edit_label');?></a>
