...
<div class="footer_outer fl clr">
      ...
      <?php if( ($site_settings[0]['maintenance_mode'] == IN_ACTIVE) || (isset($auction_userid) && ($user_type == ADMIN) ) ){?>
        ...
        <ul class="footer-list">
          <li><a title=" <?php echo __('menu_register');?>" href="<?php echo URL_BASE;?>users/signup"> <?php echo __('register_now');?></a> </li>
                                <li><a href="<?php echo URL_BASE;?>cmspage/page/what-auction" title="<?php echo __('what_auctions');?> "><?php echo __('what_auctions');?> </a></li>
	...
	<li><a href="<?php echo URL_BASE;?>cmspage/page/<?php echo $sta['page_url'];?>" title="<?php echo $sta['page_title'];?>"><?php echo $sta['page_title'];?></a><?php endforeach;?>
      ...
      <div class="footer-section4">
       ...
       <?php if( ($site_settings[0]['maintenance_mode'] == IN_ACTIVE) || (isset($auction_userid) && ($user_type == ADMIN) ) ){?>
   <h6 class="clr" title="<?php echo __('secure_payments');?>"><?php echo __('pay_safe_with');?></h6>
