...
<div class="action_content_left fl">
		...
		<table width="660" border="0" align="left" cellpadding="0" cellspacing="0" class="table-top">
		        <tr>
		                <td width="100" align="center"><?php echo __('friend_image');?></td>
        ...
        <script type="text/javascript">
	        $.getJSON("https://graph.facebook.com/<?php echo $id;?>",function(data){
                ...
                <tr>
                        ...
                        <img src="https://graph.facebook.com/<?php echo $id;?>/picture"  title="" alt="" align="center"/>
                        </td>
                        <td width="200" align="center" class=""><p class="watch_list_title  name<?php echo $i;?>">--</p></td>
                        <td width="100" align="center" class=""><p class="watch_list_title">
                        <?php 
