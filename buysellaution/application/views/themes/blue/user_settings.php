	...
	<?php echo Form::open(NULL,array('method'=>'post','enctype' => 'multipart/form-data'));?>
       ...
       <div class="row_colm1 fl clr mt20" style="width:600px;">
        ...
        <label class="errore_msg fl clr"><span class="red"><?php if($errors){ echo (array_key_exists('lastname',$errors))? ucfirst($errors['lastname']):"";}?></span></label>
          ...
          <div class="row_colm1 fl clr mt20" style="width:590px;float:left;">
               ...
               <div id="showmap" style="position:relative;">  
		<div class="rupling" style="width:360px;">
			 
				<span class="nodus2"><input type="button" value="<?php echo __('search_label');?>" onclick="showAddress()"  /></span>
		</div>
	<?php /*	<div id="map_close" style="align:right;margin-top:2px;padding:10px;color:#999;anchor;">Close X</div> */?>
		<div>
		...
		<?php
			...
			if(($user['photo']) && (file_exists(DOCROOT.USER_IMGPATH.$user['photo'])))
			  	...
			  	$user_image_path = URL_BASE.USER_IMGPATH.$user['photo'];
			   	...
			   	$delete_link="<a onclick='frmdel_photo(".$user['id'].");' class='deleteicon' style='' title='$delete_title' id='photo_delete'></a>"; 
