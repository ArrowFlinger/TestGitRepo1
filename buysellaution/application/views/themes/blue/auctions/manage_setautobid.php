...
<div class="action_content_left fl">
       ...
       <!--set to bid--->
			<form name="setautobid" action="<?php echo URL_BASE;?>auctions/setautobid" method="post">
				...
				<select name="product_name" id="" onchange="" class="styled_product">
				<span id="selectcountry_product" class="select">
      ...
      <!---end--><div class="clear"></div>
       <?php 	$count=count($select_autobid);if($count>0){?>
...
$(document).ready(function () {$("#users_menu").addClass("fl active");$("#products_autobid_active").addClass("user_link_active");});
</script>
