...
if(($site_settings[0]['maintenance_mode'] != ACTIVE) || (isset($auction_userid) && $user_type == ADMIN)){ ?>
                    <?php if(!$auction_userid):?>
              <div class="connect-block fr clearfix">
			...
			<div class="action_select fr">
                        ...
                        <span class="select"></span>
                      	<form name="lang" id="lang" method="post"  onsubmit="javascript:document.forms['lang'].submit();">
                                <select name="language" id="language" class="styled">
                                <?php 
