...
<input type="hidden" id="theme_name" value="<?php echo THEME; ?>"/>
		<div class="serverurl" style="display:none;" title="<?php echo url::base();?>auctions/servertime" style="border:1px solid red"><?php echo time();?></div>
                	...
                	$check_msg = Message::get();
                        if($check_msg){
                         ?>
							...
							<?php echo $content;?>
							<!--Hide The Right sider bar-->
							<?php //echo new View(THEME_FOLDER."auctions/right");?>
							<!--Hide The Right sider bar End-->
		        		</div>
                   	</div>
               	</div>     	    
				<!--User message--> 
