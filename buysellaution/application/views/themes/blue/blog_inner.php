...
<div class="container_inner fl clr">
                    ...
                    <div class="blog_content fl">
                        ...
                        <div class="blog_content fl clr">
                            <label class="fr blog_post_time mr10 mt5">
                                <?php echo __('posted_on').date('F d Y',strtotime($get_blog_auctions['created_date']))." Admin";?>
                            </label>
                        </div>
                        <div class="blog_content fl clr">
	...
	<?php $count=$get_blog_auctions['comments_count']; ?>
    	...
    	<div class="blog_reply_list fl clr mt15">    
            <?php 
		...
		?>
            ...
            <div id="managetable" style="width:915px!important;" class="blog_reply_content fl clr">
                <ul class="fl clr">
                    <li class="fl clr  mt5">
                        <b class="blog_reply_title fl clr"><?php echo ucfirst($get_blog_comments['username_blog']). "   ".__('says');?></b>
                        <div class="blog_reply_content fr clr">
                                <label class="fr blog_post_time mr10 mt5" style="text-align:right;padding-right:10px;">
	...
	<div class="blog_reply_list fl clr mt15 ml10 pb10">    
        ...
        <table  class="fl clr pb10">
                ...
                <div class="colm1_width fl"><b> <?php echo $label;?> <span class="red">*</span>:</b></div>
                ...
                <td>
                <div class="row_colm1 fl clr mt20">
                <div class="colm1_width fl"><b><?php echo __('email_label');?> <span class="red">*</span>: </b></div>
                <div class="colm2_width fl">
                <div class="inputbox_out fl">
                <?php if(isset($auction_userid)):?>
                ...
                <td>
                <div class="row_colm1 fl clr mt20">
                <div class="colm1_width fl"><b> <?php echo __('comment_label');?><span class="red">*</span> :</b></div>
                <div class="colm2_width fl">
