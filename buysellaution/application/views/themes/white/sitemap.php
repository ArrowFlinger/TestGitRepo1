    ...
    <div class="footer_content">
        ...
        <h6><?php echo __('menu_registration');?></h6>
                <ul class="footer-list">
                        <li><a title=" <?php echo __('menu_register');?>" target="_self" title="<?php echo __('menu_register');?>" href="<?php echo URL_BASE;?>users/signup"><?php echo __('menu_register');?></a> </li>
                        <li><a href="<?php echo url::base();?>users/forgot_password"  target="_self" title="<?php echo __('forgot_password');?>"><?php echo __('forgot_password');?></a></li>
                </ul>
        </div>
