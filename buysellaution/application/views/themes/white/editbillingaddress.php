...
<div class="my_message_right">
	<div class="message_common_border">
		<h1 style="width:170px;" title="<?php echo strtoupper(__('edit_billing_address'));?>"><?php echo strtoupper(__('edit_billing_address'));?></h1>
	...
	<div class="message_common">
		...
		<div class="login_middle_common_profil">
			...
			<div class="user_name_common">
				...
				<div class="text_feeld">
					<h2>
						<?php $phone=($db_values[0]['phoneno']!="")?$db_values[0]['phoneno']:"";
