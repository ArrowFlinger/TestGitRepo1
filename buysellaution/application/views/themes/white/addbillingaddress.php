...
<div class="my_message_right">
	<div class="message_common_border">
		<h1 style="width:auto;" title="<?php echo strtoupper(__('add_billing_address'));?>">
			<?php echo strtoupper(__('add_billing_address'));?>
		</h1>
		<p style="width:519px;">&nbsp;</p>
	</div>
	...
	<div class="message_common">
		<div class="login_middle_common_profil">
			...
			<div class="user_name_common">
				...
				<span class="red">  <?php if($errors && array_key_exists('country',$errors)){?><?php echo (array_key_exists('country',$errors))? $errors['country']:"";?><?php }?></span></label>
			</div>
			<div class="user_name_common">
			...
			<div class="user_name_common">
				...
				<div class="profil_butoon">
					...
					<div class="save_mid"><a href="<?php echo URL_BASE;?>users/myaddresses" title="<?php echo strtoupper(__('back_button'));?>"><input type="button" value="<?php echo strtoupper(__('back_button'));?>" title="<?php echo strtoupper(__('back_button'));?>"/></a></div>
