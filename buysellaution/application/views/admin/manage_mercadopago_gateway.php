...
$payment_method_live_checked="checked='checked'"; }
 ...
 if(isset($payment_gateway_details)){
		  $payment_gateway_details['mercado_api_username']=$payment_gateway_details['paypal_api_username'];
		  $payment_gateway_details['mercado_api_password']=$payment_gateway_details['paypal_api_password'];
 }
...
<div class="content_top"><div class="top_left"></div><div class="top_center"></div><div class="top_rgt"></div></div>
        <div class="content_middle">
				...
				<span class="info_label" id="info_label"><?php echo __('info_product_name');?>:<?php echo $product_settings[0]['max_desc_length'];?></span>
	                         ...
	                         <tr>      
									        <td class="big_text"><?php echo __('mercado_settings_label');?></td>
									</tr>
									<tr>
											 <td valign="top"> <label><?php echo __('mercado_account_type');?></label></td>
												<td>
									...
									<tr>
											  <td valign="top"> <label><?php echo __('mercado currency code');?></label></td>
												<td> 
								  ...
								  <tr>
									      <td valign="top"><label><?php echo __('mercado_api_username_label');?></label><span class="star">*</span></td>
									      <td>
						<input type="text" class="required"  name="mercado_api_username" maxlength='50' id="mercado_api_username"  value="<?php echo isset($payment_gateway_details['mercado_api_username']) && !array_key_exists('mercado_api_username',$errors)? trim($payment_gateway_details['mercado_api_username']):$validator['mercado_api_username'];?>" maxlength="500"/> 
                                   <span class="error">
                                        <?php echo isset($errors["mercado_api_username"])? ucfirst($errors["mercado_api_username"]):""; ?>
                                   </span> 									
											</td>
								  </tr>
                                <tr>								
                                        <td valign="top"> <label><?php echo __('mercado api password_label');?></label><span class="star">*</span></td>
                                        <td>
                                        <input type="text" class="required" maxlength='50'  name="mercado_api_password" maxlength="256" id="mercado_api_password" value="<?php echo isset($payment_gateway_details['mercado_api_password']) && !array_key_exists('mercado_api_password',$errors)? trim($payment_gateway_details['mercado_api_password']):$validator['mercado_api_password'];?>" /> 
                                        <span class="error">
                                        <?php echo isset($errors["mercado_api_password"])? ucfirst($errors["mercado_api_password"]):""; ?>
                                        </span> 									
                                        </td>
                                </tr>
                                ...
                                <tr>
	<td valign="top"><label><?php echo __('mercado status');?></label></td>
