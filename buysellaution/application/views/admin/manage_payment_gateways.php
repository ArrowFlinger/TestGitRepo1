				...
				<span class="info_label" id="info_label"><?php echo __('info_product_name');?>:<?php echo $product_settings[0]['max_desc_length'];?></span>
	                         ...
	                         <tr>      
								  ...
								  <tr>
									      ...
									      <td>
						<input type="text" class="required"  name="paypal_api_username" id="paypal_api_username"  value="<?php echo isset($payment_gateway_details['paypal_api_username']) && !array_key_exists('paypal_api_username',$errors)? trim($payment_gateway_details['paypal_api_username']):$validator['paypal_api_username'];?>" maxlength="500"/> 
                                   <span class="error">
                                        <?php echo isset($errors["paypal_api_username"])? ucfirst($errors["paypal_api_username"]):""; ?>
                                   </span> 									
											</td>
								  </tr>
                                <tr>								
                                        ...
                                        <td>
                                        <input type="password" class="required"  name="paypal_api_password" maxlength="256" id="paypal_api_password" value="<?php echo isset($payment_gateway_details['paypal_api_password']) && !array_key_exists('paypal_api_password',$errors)? trim($payment_gateway_details['paypal_api_password']):$validator['paypal_api_password'];?>" /> 
                                        <span class="error">
                                        <?php echo isset($errors["paypal_api_password"])? ucfirst($errors["paypal_api_password"]):""; ?>
                                        </span> 									
                                        </td>
                                </tr>
									<tr>
                                   ...
                                   <span class="error">
                                        <?php echo isset($errors["paypal_api_signature"])? ucfirst($errors["paypal_api_signature"]):""; ?>
                                   </span> 									
											</td>
									</tr>
                           <tr>
