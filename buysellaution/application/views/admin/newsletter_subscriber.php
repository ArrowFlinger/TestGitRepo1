                        ...
                        <tr>
                                ...
                                <td><select name="user_status" id="user_status" onchange="return get_users(this.value);">
									<option value=""><?php echo __('select'); ?></option>
				            			<?php  foreach($subscribe AS $status_key => $allstatus) { 
								 			$selected_status=($flag=='0' && $status_val==$status_key) ? ' selected="selected" ' : " ";  ?>  
                                    		<option value="<?php echo $status_key;?>"><?php  echo $allstatus; ?></option>  
						    			<?php } ?>
									</select>
...
<div id="url" name="<?php echo URL_BASE;?>settings/builduser_nletter"></div>
