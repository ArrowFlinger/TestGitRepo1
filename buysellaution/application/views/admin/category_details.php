<?php defined('SYSPATH') OR die("No direct access allowed."); 
 ...
 /* Status Box Checked */
//------------------------
 if(isset($product_categories['status'])	&& $product_categories['status']=="A")
 { $status_checked="checked='checked'"; }
 else if(isset($product_categories['status'])	&& $product_categories['status']=="I")
 { $status_checked=""; }
 else
 { $status_checked=""; }
?>
...
<div class="content_top"><div class="top_left"></div><div class="top_center"></div><div class="top_rgt"></div></div>
        <div class="content_middle">
                <form method="post" class="admin_form" name="frmjob_cat" id="frmjob_cat" action ="<?php echo URL_BASE;?>category/<?php echo $action;?>">
                <table border="0" width="100%" align="left" cellpadding="10" cellspacing="0">
                        <tr>
                                ...
                                <td valign="middle">
                                    <input type="text" name="category_name" id="category_name" maxlength="25" value="<?php echo isset($product_categories['category_name']) && !array_key_exists('category_name',$errors) ? trim($product_categories['category_name']) : $validator['category_name']; ?>" />
					...
					<?php echo $category_exists; ?><?php echo isset ($errors['category_name'])?ucfirst($errors['category_name']):""; ?>
                        ...
                        <tr>
                                <td colspan="3" style="padding-left:110px;">
                                  <br />
                                  <input type="button" value="<?php echo __('button_back'); ?>" onclick="location.href='<?php echo URL_BASE;?>category/manage_category'" />
