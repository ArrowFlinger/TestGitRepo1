...
class Kohana_Valid {
	...
	/**
	 * Checks if a field is contain only numbers.
	 *
	 * @return  boolean
	 */
	public static function not_numbers($value)
	{
		return !(bool) preg_match( '/^[0-9()+_-]++$/i', (string) $value);
	}
	/**
	...
	public static function regex($value, $expression)
	{
        ...
        public static function illegal_chars($value, $expression)
	{
		return (bool) preg_match($expression, (string) $value);
	}
	...
	/**
	 * Checks if a field count the value equals to another field.
	 *
	 * @param   array    array of values
	 * @param   array  array of values
	 * 
	 * @return  boolean
	 */
	public static function array_count_equals($array1, $array2)
	{
		return (count($array1)=== count($array2));
	}
	
	/**
	 * Checks if a field value greater of another field.
	 *
	 * @param   array    array of values
	 * @param   array  array of values
	 * @return  boolean
	 */
	public static function compare_value_greater($array1, $array2)
	{
	       
	        for($init=0;$init<count($array1);$init++){
	                if($array1[$init] <= $array2[$init]){
	                        return false;
	                }
	        } 
		return true;
	 ...
	 * @return  boolean
	 */
	public static function compare_value_greater_equal($array1, $array2)
	{
	 ...
	 * @return  boolean
	 */
	public static function array_unique_values($array)
	{
	       $array_org = $array;
	       $array = array_unique($array);
	        return (count($array_org)=== count(array_unique($array)));
	}

	 //function for custom numeric (Remove (-) in this rule) add aug 30
	public static function custom_price_numeric($str)
	{
		// Get the decimal point for the current locale
		list($decimal) = array_values(localeconv());
	 ...
	 //function for custom numeric (Remove (-) in this rule) add aug 30
	public static function custom_numeric($str)
	{
		// Get the decimal point for the current locale
		list($decimal) = array_values(localeconv());
	...
	/**
	 * venkatraja added for custom range
	 * Tests if a number is within a range.
	 *
	 * @param   string   number to check
	 * @param   integer  minimum value
	 ...
	 * @return  boolean
	 */
	public static function custom_range($number, $min, $max)
	{
		return ($number >= $min AND $number <= $max);
	}
